...
public static class PhysicsConstants
{
    ...
    public const double CushionRestitution = 0.94; // slightly livelier cushions for a touch more bounce
    ...
    public const double SlipToLinearAccel = 1.85;      // forward/back acceleration from longitudinal slip
    public const double SideSpinDecayBase = 1.0;       // base side spin decay from cloth drag
    public const double SideSpinDecayBySpeed = 0.5;    // extra side spin decay as speed rises
    public const double SideSpinDecayBySlip = 0.8;     // extra side spin decay when side spin is extreme
    public const double SwerveMinSpeed = 0.12;         // below this speed, visible swerve is effectively gone
    public const double SwervePeakSpeed = 1.4;         // peak speed band for cloth-induced cue-ball swerve
