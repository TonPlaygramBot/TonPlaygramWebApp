...
public static class PhysicsConstants
{
    ...
    public const double MasseSwerveBoost = 1.6;        // additional swerve scaling when cue is elevated
    public const double MasseAngleMinDegrees = 25.0;   // start of noticeable masse swerve
    public const double MasseAngleMaxDegrees = 75.0;   // max masse swerve
    public const double SwerveSpeedCutoff = 6.0;       // reduce masse boost at high speeds (m/s)
    ...
    public const double JumpImpulseScale = 0.7;        // scales vertical component of the cue strike
    public const double JumpVelocityThreshold = 1.1;   // m/s minimum vertical speed for airborne
    public const double JumpSpinBias = 0.3;            // adds to threshold per unit tip offset
    public const double LandingSpeedRetention = 0.88;  // horizontal speed retained after landing
    public const double LandingSpinRetention = 0.85;   // spin retained after landing
    public const double AirborneHeightThreshold = BallRadius * 0.25; // height before ignoring cushions/balls
    public const double MaxCueElevationDegrees = 85.0; // clamp cue elevation for jump shots
