...
const CHAIR_GAP = -0.04 * MODEL_SCALE; // pull chairs visually closer to the table edge
const CHAIR_OUTWARD_OFFSET = 0;
const CHAIR_RADIUS =
  TABLE_RADIUS + SEAT_DEPTH * 0.5 + CHAIR_GAP + CHAIR_OUTWARD_OFFSET;
const CHAIR_GLOBAL_PUSHBACK = 0.1 * MODEL_SCALE;
const SELF_BOTTOM_CHAIR_EXTRA_PUSHBACK = 0.16 * MODEL_SCALE;
...
const SIDE_PLAYER_TABLE_PULL_IN = 0.68 * MODEL_SCALE;
...
const CAMERA_REAR_OFFSET = {
  portrait: 0.2 * CAMERA_LAYOUT_SCALE,
