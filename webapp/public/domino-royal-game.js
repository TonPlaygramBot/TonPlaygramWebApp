...
const CAMERA_MIN_POLAR = 0.86;
const CAMERA_MAX_POLAR = 1.14;
...
const CAMERA_REAR_OFFSET = {
  portrait: 0.96 * CAMERA_LAYOUT_SCALE,
  landscape: 0.62 * CAMERA_LAYOUT_SCALE
};
const CAMERA_HEIGHT_BOOST = {
  portrait: 2.9 * CAMERA_LAYOUT_SCALE,
  landscape: 1.5 * CAMERA_LAYOUT_SCALE
};
...
const CAMERA_TARGET = new THREE.Vector3(
  0,
  CAMERA_REFERENCE_TABLE_HEIGHT + CAMERA_TARGET_LIFT + CAMERA_TARGET_EXTRA,
  0
);
...
const TABLE_PLAYFIELD_SIDE_EXPANSION = 1.28;
const NON_GOTHIC_TABLE_WIDTH_BOOST = 1.16;
const COFFEE_TABLE_TOP_BOTTOM_WIDTH_BOOST = 1.12;
const MODERN_COFFEE_LEFT_RIGHT_WIDTH_BOOST = 1.12;
...
const DOMINO_EXTRA_SHRINK_FACTOR = 0.74;
const DOMINO_SCALE =
  1.5 *
  1.26 *
...
const PLAYER_HAND_OUTWARD_OFFSET = DOMINO_WIDTH * 1.58;
const PLAYER_HAND_VERTICAL_RAISE = DOMINO_WIDTH * 0.11;
const HUMAN_HAND_OUTWARD_OFFSET = DOMINO_WIDTH * 5.15;
const HUMAN_HAND_VERTICAL_OFFSET = DOMINO_WIDTH * 0.065;
const HUMAN_BOTTOM_EXTRA_OUTWARD = DOMINO_WIDTH * 0.98;
const HUMAN_BOTTOM_EXTRA_RAISE = DOMINO_WIDTH * 0.145;
const HUMAN_BOTTOM_HAND_GAP_SCALE = 0.56;
const DOMINO_DOUBLE_NEIGHBOR_EXTRA_GAP = DOMINO_WIDTH * 0.2;
...
function computeHandSlotPosition(
  ...
  const MIN_GAP = DOMINO_LENGTH * 0.66;
