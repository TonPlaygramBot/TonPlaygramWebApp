...
const DOMINO_EXTRA_SHRINK_FACTOR = 0.85;
const DOMINO_SCALE =
  1.5 *
  1.26 *
...
const PLAYER_HAND_OUTWARD_OFFSET = DOMINO_WIDTH * 0.44;
const PLAYER_HAND_VERTICAL_RAISE = DOMINO_WIDTH * 0.11;
const HUMAN_HAND_OUTWARD_OFFSET = DOMINO_WIDTH * 3.35;
const HUMAN_HAND_VERTICAL_OFFSET = DOMINO_WIDTH * 0.065;
const HUMAN_BOTTOM_EXTRA_OUTWARD = DOMINO_WIDTH * 0.52;
