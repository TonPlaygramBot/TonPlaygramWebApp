...
const PLAYER_HAND_OUTWARD_OFFSET = DOMINO_WIDTH * 5.25;
const HUMAN_PLAYER_HAND_OUTWARD_OFFSET = DOMINO_WIDTH * 7.25;
const PLAYER_HAND_VERTICAL_RAISE = DOMINO_WIDTH * 3.65;
const PLAYER_HAND_CENTER_VERTICAL_DROP = DOMINO_WIDTH * 3.2;
const HUMAN_HAND_OUTWARD_OFFSET = DOMINO_WIDTH * 6.2;
const HUMAN_HAND_VERTICAL_OFFSET = DOMINO_WIDTH * 0.0;
const HUMAN_BOTTOM_EXTRA_OUTWARD = DOMINO_WIDTH * 1.2;
