...
const DOMINO_AND_CHAIR_SHRINK_FACTOR = 0.85; // extra 15% reduction requested for dominoes/chairs
const LEGACY_TABLE_SIZE_REDUCTION_FACTOR = 0.68;
const TABLE_SHRINK_FACTOR = 0.8;
const TABLE_AND_CHAIR_SHRINK_FACTOR = 0.85; // additional 15% downscale for arena furniture
...
const DOMINO_SCALE = 1.5 * 1.26 * DOMINO_SHRINK_FACTOR * DOMINO_AND_CHAIR_SHRINK_FACTOR;
