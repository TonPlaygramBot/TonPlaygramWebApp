...
const CHAIR_GAP = -0.02 * MODEL_SCALE; // pull chairs inward so they sit closer to the table in portrait
const CHAIR_OUTWARD_OFFSET = 0;
const CHAIR_RADIUS =
  TABLE_RADIUS + SEAT_DEPTH * 0.5 + CHAIR_GAP + CHAIR_OUTWARD_OFFSET;
const CHAIR_GLOBAL_PUSHBACK = 0.3 * MODEL_SCALE;
const SELF_BOTTOM_CHAIR_EXTRA_PUSHBACK = 0.54 * MODEL_SCALE;
const CHAIR_VISUAL_SCALE = 0.84;
...
const DOMINO_HUMAN_CHARACTER_SCALE_BOOST = 0.82;
