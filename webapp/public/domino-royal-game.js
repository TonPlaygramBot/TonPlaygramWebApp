...
const PLAYER_HAND_VISIBLE_EDGE_GAP = DOMINO_WIDTH * 0.08;
...
function computeHandSlotPosition(
  ...
  const scaledTileWidth = DOMINO_WIDTH * PLAYER_HAND_TILE_SCALE;
  const visibleGap = scaledTileWidth + PLAYER_HAND_VISIBLE_EDGE_GAP;
  const MIN_GAP = Math.max(
    DOMINO_LENGTH * 0.82 * PLAYER_HAND_MIN_GAP_SCALE,
    isHuman && !openFlat ? visibleGap / HUMAN_BOTTOM_HAND_GAP_SCALE : visibleGap
  );
