...
const CAMERA_HEIGHT_BOOST = {
  portrait: 2.7 * CAMERA_LAYOUT_SCALE,
  landscape: 1.2 * CAMERA_LAYOUT_SCALE
};
const CAMERA_PORTRAIT_LOOKDOWN_EXTRA = 0.11 * MODEL_SCALE;
...
const TABLE_PLAYFIELD_SIDE_EXPANSION = 1.22;
...
const DOMINO_SIZE_BOOST = 1.5; // requested: ~50% larger domino visuals
const DOMINO_SCALE =
  1.5 *
  1.26 *
...
const PLAYER_HAND_OUTWARD_OFFSET = DOMINO_WIDTH * 1.32;
const PLAYER_HAND_VERTICAL_RAISE = DOMINO_WIDTH * 0.11;
const HUMAN_HAND_OUTWARD_OFFSET = DOMINO_WIDTH * 4.9;
...
const DOMINO_DOUBLE_NEIGHBOR_EXTRA_GAP = DOMINO_WIDTH * 0.22;
...
const DOMINO_VERTICAL_LIFT = DOMINO_WIDTH * 0.04; // slight upward lift for better visibility
const HAND_Y = RAIL_TOP + TILE_UP_HALF - 0.0025 + DOMINO_VERTICAL_LIFT;
const CHAIN_TILE_Y = CLOTH_TOP + 0.0018 + DOMINO_VERTICAL_LIFT;
