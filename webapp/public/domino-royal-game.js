...
const HAND_Y = RAIL_TOP + TILE_UP_HALF + 0.0032;
const CHAIN_TILE_Y = CLOTH_TOP + 0.019; // keep dominoes visually grounded after lowering table height
