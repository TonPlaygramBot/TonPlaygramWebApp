...
function createDominoCharacterRig(instance, seatRoot, seatIndex, player) {
  ...
  // Lower both arms toward the domino line; drop the bottom (human) seat a bit more.
  const isBottomSeat = seatIndex === human;
  const upperArmDropDeg = isBottomSeat ? 8 : 4;
  const foreArmDropDeg = isBottomSeat ? 6 : 3;
  const handDropDeg = isBottomSeat ? 5 : 2.5;
  addDominoBoneOffset(bones.leftUpperArm, THREE.MathUtils.degToRad(-73 - upperArmDropDeg), THREE.MathUtils.degToRad(-7), THREE.MathUtils.degToRad(-3.5));
  addDominoBoneOffset(bones.leftForeArm, THREE.MathUtils.degToRad(69 + foreArmDropDeg), THREE.MathUtils.degToRad(-3), THREE.MathUtils.degToRad(-1.5));
  addDominoBoneOffset(bones.leftHand, THREE.MathUtils.degToRad(41 + handDropDeg), THREE.MathUtils.degToRad(-4), THREE.MathUtils.degToRad(-1.5));
  addDominoBoneOffset(bones.rightUpperArm, THREE.MathUtils.degToRad(-78 - upperArmDropDeg), THREE.MathUtils.degToRad(10), THREE.MathUtils.degToRad(5.5));
  addDominoBoneOffset(bones.rightForeArm, THREE.MathUtils.degToRad(71 + foreArmDropDeg), THREE.MathUtils.degToRad(6), THREE.MathUtils.degToRad(2.5));
  addDominoBoneOffset(bones.rightHand, THREE.MathUtils.degToRad(43 + handDropDeg), THREE.MathUtils.degToRad(6), THREE.MathUtils.degToRad(2.5));
