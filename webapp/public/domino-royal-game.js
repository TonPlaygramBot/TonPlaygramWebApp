...
const STOOL_SCALE = 1.5 * 1.38 * 0.8 * TABLE_SIZE_REDUCTION_FACTOR;
...
const CHAIR_VISUAL_SCALE = 1.408 * TABLE_SIZE_REDUCTION_FACTOR;
...
const CHAIN_TILE_Y = CLOTH_TOP + 0.0034; // keep dominoes visually lower so they align with the shorter table
