...
const CHAIR_GLOBAL_PUSHBACK = 0.42 * MODEL_SCALE;
...
const TABLE_PLAYFIELD_SIDE_EXPANSION = 1.0;
...
const DOMINO_EXTRA_SHRINK_FACTOR = 0.6;
const DOMINO_SIZE_BOOST = 1.78;
const DOMINO_SCALE =
  1.5 *
  1.26 *
...
// Bottom-seat only: keep the local player hand visually on the front rail/apron area.
