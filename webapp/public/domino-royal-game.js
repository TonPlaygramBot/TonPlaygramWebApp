...
const TABLE_CHAIRS_DOMINO_SHRINK_FACTOR = 0.8; // 20% smaller table, chairs, and dominoes
const DOMINO_AND_CHAIR_SHRINK_FACTOR = 0.612;
...
const TABLE_RADIUS =
  3.4 * MODEL_SCALE * TABLE_RADIUS_SCALE * TABLE_CHAIRS_DOMINO_SHRINK_FACTOR;
const BASE_TABLE_HEIGHT =
  1.08 * MODEL_SCALE * TABLE_HEIGHT_SCALE * TABLE_CHAIRS_DOMINO_SHRINK_FACTOR;
...
const STOOL_SCALE =
  ...
  TABLE_CHAIRS_DOMINO_SHRINK_FACTOR;
