...
const PLAYER_HAND_OUTWARD_OFFSET = DOMINO_WIDTH * 1.94;
const PLAYER_HAND_VERTICAL_RAISE = DOMINO_WIDTH * 0.11;
const HUMAN_HAND_OUTWARD_OFFSET = DOMINO_WIDTH * 1.96;
...
const CHAIN_EDGE_PADDING = Math.max(0.16, DOMINO_LENGTH * 0.46);
