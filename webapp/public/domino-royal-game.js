...
const PLAYER_HAND_OUTWARD_OFFSET = DOMINO_WIDTH * 5.35;
const HUMAN_PLAYER_HAND_OUTWARD_OFFSET = DOMINO_WIDTH * 7.35;
const PLAYER_HAND_VERTICAL_RAISE = DOMINO_WIDTH * 3.65;
...
const HUMAN_BOTTOM_EXTRA_RAISE = DOMINO_WIDTH * 6.45;
...
const DOMINO_HELD_RACK_OUTWARD_OFFSET = 0.58 * MODEL_SCALE;
const DOMINO_HELD_RACK_BOTTOM_HAND_LIFT = 0.94 * MODEL_SCALE;
const DOMINO_HELD_RACK_BOTTOM_OUTWARD_OFFSET = 0.9 * MODEL_SCALE;
