...
const SIDE_PLAYER_TABLE_PULL_IN = 0.3 * MODEL_SCALE;
...
const CAMERA_PORTRAIT_LOOKDOWN_EXTRA = 0.04 * MODEL_SCALE;
...
const PLAYER_HAND_OUTWARD_OFFSET = DOMINO_WIDTH * 4.84;
const PLAYER_HAND_OPPONENT_OUTWARD_EXTRA = DOMINO_WIDTH * 0.22;
const PLAYER_HAND_SIDE_OUTWARD_EXTRA = DOMINO_WIDTH * 0.14;
// Only non-bottom racks move outward: keep the bottom player's dominoes untouched.
const PLAYER_HAND_TOP_OUTWARD_EXTRA = DOMINO_WIDTH * 0.16;
const PLAYER_HAND_SIDE_EDGE_OUTWARD_EXTRA = DOMINO_WIDTH * 0.1;
const HUMAN_PLAYER_HAND_OUTWARD_OFFSET = DOMINO_WIDTH * 4.92;
const PLAYER_HAND_VERTICAL_RAISE = DOMINO_WIDTH * 4.18;
const PLAYER_HAND_OPPONENT_VERTICAL_EXTRA = DOMINO_WIDTH * 0.24;
const PLAYER_HAND_CENTER_VERTICAL_DROP = DOMINO_WIDTH * 2.7;
const HUMAN_HAND_OUTWARD_OFFSET = DOMINO_WIDTH * 5.02;
const HUMAN_HAND_VERTICAL_OFFSET = DOMINO_WIDTH * 0.0;
const HUMAN_BOTTOM_EXTRA_OUTWARD = DOMINO_WIDTH * 1.9;
const HUMAN_BOTTOM_EXTRA_RAISE = DOMINO_WIDTH * 4.25;
...
const HAND_Y = RAIL_TOP + TILE_UP_HALF - DOMINO_WIDTH * 0.03 + DOMINO_LIFT_OFFSET;
...
const DOMINO_HUMAN_CHARACTER_EXTRA_LOWER_OFFSET = -0.12;
...
const DOMINO_HELD_RACK_HAND_LIFT = 0.94 * MODEL_SCALE;
...
const DOMINO_HELD_RACK_BOTTOM_HAND_LIFT = 0.9 * MODEL_SCALE;
