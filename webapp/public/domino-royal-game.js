...
const TABLE_RADIUS_WIDEN_FACTOR = 1.18; // wider table footprint while keeping table height unchanged
const TABLE_RADIUS_SCALE = 0.79 * TABLE_SIZE_REDUCTION_FACTOR * TABLE_RADIUS_WIDEN_FACTOR;
...
const CHAIR_OUTWARD_OFFSET = 0.76 * MODEL_SCALE; // push chairs farther out so edge distance reads consistent after widening
const CHAIR_RADIUS =
...
const DOMINO_EXTRA_SHRINK_FACTOR = 0.675; // make only dominoes a bit smaller
const DOMINO_SCALE =
  1.5 *
  1.26 *
