...
const PLAYER_HAND_VERTICAL_RAISE = DOMINO_WIDTH * 4.15;
...
const HUMAN_BOTTOM_EXTRA_RAISE = DOMINO_WIDTH * 4.45;
...
function buildDominoFallbackCharacterTemplate() {
  ...
  leftArm.position.set(-0.22, 0.87, 0.23);
  leftArm.rotation.set(THREE.MathUtils.degToRad(69), 0, THREE.MathUtils.degToRad(-14));
  const rightArm = makeLimb(0.045, 0.46, suit);
  rightArm.position.set(0.22, 0.87, 0.23);
  rightArm.rotation.set(THREE.MathUtils.degToRad(69), 0, THREE.MathUtils.degToRad(14));
...
function createDominoCharacterRig(instance, seatRoot, seatIndex, player) {
  ...
  addDominoBoneOffset(bones.leftUpperArm, THREE.MathUtils.degToRad(-76), THREE.MathUtils.degToRad(-7), THREE.MathUtils.degToRad(-1));
  addDominoBoneOffset(bones.leftForeArm, THREE.MathUtils.degToRad(31), THREE.MathUtils.degToRad(-4), THREE.MathUtils.degToRad(0));
  addDominoBoneOffset(bones.leftHand, THREE.MathUtils.degToRad(5), THREE.MathUtils.degToRad(-5), THREE.MathUtils.degToRad(0));
  addDominoBoneOffset(bones.rightUpperArm, THREE.MathUtils.degToRad(-83), THREE.MathUtils.degToRad(12), THREE.MathUtils.degToRad(3));
  addDominoBoneOffset(bones.rightForeArm, THREE.MathUtils.degToRad(33), THREE.MathUtils.degToRad(7), THREE.MathUtils.degToRad(2));
  addDominoBoneOffset(bones.rightHand, THREE.MathUtils.degToRad(6), THREE.MathUtils.degToRad(7), THREE.MathUtils.degToRad(2));
