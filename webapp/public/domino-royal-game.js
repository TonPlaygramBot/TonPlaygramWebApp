...
const PLAYER_HAND_SIDE_OUTWARD_EXTRA = DOMINO_WIDTH * -0.1;
// Only non-bottom racks move outward: keep the bottom player's dominoes untouched.
const PLAYER_HAND_TOP_OUTWARD_EXTRA = DOMINO_WIDTH * -0.12;
...
const PLAYER_HAND_OPPONENT_VERTICAL_EXTRA = DOMINO_WIDTH * 0.56;
