...
const TABLE_SIZE_REDUCTION_FACTOR =
  LEGACY_TABLE_SIZE_REDUCTION_FACTOR * TABLE_SHRINK_FACTOR;
...
const STOOL_SCALE = 1.5 * 1.38 * 0.8 * LEGACY_TABLE_SIZE_REDUCTION_FACTOR;
...
const LEGACY_TABLE_RADIUS =
  3.4 * MODEL_SCALE * 0.79 * LEGACY_TABLE_SIZE_REDUCTION_FACTOR;
const CHAIR_RADIUS =
  LEGACY_TABLE_RADIUS + SEAT_DEPTH * 0.38 + CHAIR_GAP + CHAIR_OUTWARD_OFFSET;
const CHAIR_VISUAL_SCALE = 1.408 * LEGACY_TABLE_SIZE_REDUCTION_FACTOR;
