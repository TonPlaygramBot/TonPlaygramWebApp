...
const DOMINO_CHARACTER_CHAIR_COORDINATE_OUTWARD_RATIO = 0.44;
const DOMINO_CHARACTER_EXTRA_OUTWARD_OFFSET =
  CHAIR_DIMENSIONS.seatDepth *
  CHAIR_VISUAL_SCALE *
  DOMINO_CHARACTER_CHAIR_COORDINATE_OUTWARD_RATIO;
const DOMINO_HUMAN_CHARACTER_EXTRA_OUTWARD_OFFSET = 0.86; // pull the human avatar in the opposite direction from the previous portrait offset.
