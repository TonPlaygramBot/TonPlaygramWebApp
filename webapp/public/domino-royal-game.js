...
const CHAIR_GAP = 0.05 * MODEL_SCALE; // move chairs inward, closer to the table for portrait framing
...
const SIDE_PLAYER_TABLE_PULL_IN = 0.62 * MODEL_SCALE;
...
const DOMINO_CHARACTER_PROPORTION_SCALE = 3.18;
const DOMINO_HUMAN_CHARACTER_SCALE_BOOST = 1.05;
...
const DOMINO_CHARACTER_INWARD_DOMINO_REACH_BIAS = 0.16;
