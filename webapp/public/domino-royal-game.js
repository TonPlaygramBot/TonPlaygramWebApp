...
const DOMINO_EXTRA_SHRINK_FACTOR = 0.66; // slightly smaller tiles for tighter portrait-phone readability
const DOMINO_SCALE =
  1.5 *
  1.26 *
...
const DOMINO_CHAIN_GAP = DOMINO_LENGTH * 0.0002; // keep chain visually touching while still avoiding overlap artifacts
const DOMINO_HAND_GAP = DOMINO_WIDTH + DOMINO_CHAIN_GAP;
const PLAYER_HAND_GAP_SCALE = 0.78;
...
const HUMAN_BOTTOM_HAND_GAP_SCALE = 0.82;
