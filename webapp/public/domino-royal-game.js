...
const DOMINO_CHARACTER_CHAIR_COORDINATE_OUTWARD_RATIO = 0.18;
const DOMINO_CHARACTER_EXTRA_OUTWARD_OFFSET =
  CHAIR_DIMENSIONS.seatDepth *
  CHAIR_VISUAL_SCALE *
  DOMINO_CHARACTER_CHAIR_COORDINATE_OUTWARD_RATIO;
const DOMINO_HUMAN_CHARACTER_EXTRA_OUTWARD_OFFSET = -0.45;
const DOMINO_CHARACTER_EXTRA_LOWER_OFFSET = 1.0;
const DOMINO_HUMAN_CHARACTER_EXTRA_LOWER_OFFSET = 0.32;
