...
const DOMINO_CHARACTER_PROPORTION_SCALE = 2.28;
const DOMINO_HUMAN_CHARACTER_SCALE_BOOST = 0.32;
// Positive chair-local Z moves seated humans visually back toward the chair
// and away from the table in the portrait Domino Battle Royal view.
const DOMINO_CHARACTER_EXTRA_OUTWARD_OFFSET = 1.22;
const DOMINO_HUMAN_CHARACTER_EXTRA_OUTWARD_OFFSET = 0.42;
const DOMINO_CHARACTER_EXTRA_LOWER_OFFSET = 1.08;
