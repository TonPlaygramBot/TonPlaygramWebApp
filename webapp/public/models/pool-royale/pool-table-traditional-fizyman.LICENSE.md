...
**fizyman**. The runtime glTF folder is intentionally not committed; install it locally or
in deployment with:
...
plus the external .bin payload and baked texture files. Pool Royale then fits that authentic model to the game
