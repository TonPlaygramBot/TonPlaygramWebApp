...
function moveRootAroundPerimeter(human, rootGoal, cfg, dt) {
  ...
  goal.y = cfg.groundY || 0;
  if (human.root.position.lengthSq() < 1e-6) human.root.position.copy(goal);
  else human.root.position.copy(clampPointToWalkPerimeter(human.root.position, perimeter)).setY(cfg.groundY || 0);
  ...
  human.root.position.copy(perimeterTToPoint(human.perimeterT, perimeter)).setY(cfg.groundY || 0);
