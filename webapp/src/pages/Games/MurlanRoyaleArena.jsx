...
const AI_SIDE_HAND_EXTRA_OUTWARD_PUSH = 1.92 * MODEL_SCALE;
const AI_TOP_HAND_EXTRA_OUTWARD_PUSH = 2.46 * MODEL_SCALE;
const AI_SIDE_HAND_UP_SHIFT_Y = -0.36 * MODEL_SCALE;
const AI_TOP_HAND_UP_SHIFT_Y = -0.16 * MODEL_SCALE;
