...
const HUMAN_HAND_CLOSER_OFFSET = 0.34 * MODEL_SCALE; // Pull the bottom player's hand/cards further inward toward table center.
...
const HUMAN_CHAIR_EXTRA_INWARD_OFFSET = 1.62 * MODEL_SCALE; // Pull only the bottom player's chair closer to the table while preserving chair size.
