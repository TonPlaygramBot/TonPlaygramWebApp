...
const AI_SIDE_HAND_EXTRA_OUTWARD_PUSH = 0.72 * MODEL_SCALE;
const AI_TOP_HAND_EXTRA_OUTWARD_PUSH = 1.02 * MODEL_SCALE;
const AI_SIDE_HAND_UP_SHIFT_Y = 0.0 * MODEL_SCALE;
const AI_TOP_HAND_UP_SHIFT_Y = 0.1 * MODEL_SCALE;
const AI_SIDE_HAND_LATERAL_PALM_SHIFT = 0.07 * MODEL_SCALE;
const AI_SIDE_HAND_TOPWARD_SHIFT = 0.78 * MODEL_SCALE;
