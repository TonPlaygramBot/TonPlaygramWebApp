...
const CAMERA_SEATED_RETREAT_OFFSETS = Object.freeze({ portrait: 0.03 * ARENA_PROP_SCALE, landscape: 0.08 * ARENA_PROP_SCALE });
const CAMERA_SEATED_ELEVATION_OFFSETS = Object.freeze({
  portrait: 0.78 * ARENA_PROP_SCALE,
  landscape: 0.56 * ARENA_PROP_SCALE
});
...
const HUMAN_HAND_CLOSER_OFFSET = 0.28 * MODEL_SCALE; // Pull the bottom player's hand/cards further inward toward table center.
const HUMAN_HAND_BOTTOM_SHIFT_Y = -0.24 * MODEL_SCALE;
const AI_HAND_BOTTOM_SHIFT_Y = -0.08 * MODEL_SCALE;
const AI_HAND_CLOSER_OFFSET = -0.08 * MODEL_SCALE;
...
const HUMAN_CHAIR_EXTRA_INWARD_OFFSET = 1.18 * MODEL_SCALE; // Pull only the bottom player's chair closer to the table while preserving chair size.
