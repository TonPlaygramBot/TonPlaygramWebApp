  ...
  const applyStateToScene = useCallback((state, selection, immediate = false) => {
    ...
    state.players.forEach((player, idx) => {
      ...
      cards.forEach((card, cardIdx) => {
        ...
        const directionalProgress = 1 - leftWeight;
        ...
        const fanYaw = isHumanCard
          ? directionalProgress * HUMAN_HAND_FAN_MAX_YAW * fanDirection
        ...
        target.y = baseHeight + (isHumanCard ? HUMAN_HAND_BOTTOM_SHIFT_Y + HUMAN_HAND_UP_SHIFT_Y + directionalProgress * HUMAN_HAND_DIRECTIONAL_LIFT : centerWeight * fanArcLift);
    ...
    state.tableCards.forEach((card, idx) => {
      ...
      const { leftWeight } = calcFanCardPose(tableCount, idx);
      const communityDirectionalProgress = 1 - leftWeight;
      const communityFanYaw = communityDirectionalProgress * HUMAN_HAND_FAN_MAX_YAW * HUMAN_HAND_FAN_DIRECTION;
      ...
      target.y += 0.075 * MODEL_SCALE + COMMUNITY_CARD_BOTTOM_LOCK_Y_OFFSET + COMMUNITY_CARD_BOTTOM_SHIFT_Y + communityDirectionalProgress * COMMUNITY_CARD_DIRECTIONAL_LIFT;
      setMeshPosition(
        mesh,
        target,
        communityLookTarget,
