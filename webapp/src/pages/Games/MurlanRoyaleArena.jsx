...
const TOP_SEAT_AVATAR_UP_LIFT = 0;
...
const CARD_SCALE = 0.95 * CARD_VISUAL_TRIM;
...
const HUMAN_HAND_BOTTOM_SHIFT_Y = -0.28 * MODEL_SCALE;
const AI_HAND_BOTTOM_SHIFT_Y = -0.12 * MODEL_SCALE;
...
const HUMAN_HAND_EXTRA_INWARD_PULL = 0.24 * MODEL_SCALE;
const AI_HAND_TABLE_EDGE_MARGIN = CARD_H * 0.2;
const HAND_CARDS_INWARD_BIAS = 0.05 * MODEL_SCALE;
