...
const CHAIR_INWARD_OFFSET = 0.34 * MODEL_SCALE; // Bring all chairs slightly closer to the shrunken table.
...
const CHAIR_SCREEN_LOWER_OFFSET = 0.1 * MODEL_SCALE; // Drop chairs a bit more on-screen after the smaller table update.
const HUMAN_CHAIR_EXTRA_INWARD_OFFSET = 0.38 * MODEL_SCALE; // Pull only the bottom player's chair closer to match new table size.
...
const CAMERA_INWARD_RADIUS_FACTOR = 0.66 * ARENA_PROP_SCALE; // Bring camera closer to the table for tighter framing.
