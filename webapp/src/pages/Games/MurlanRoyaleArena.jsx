...
const AI_HAND_BOTTOM_SHIFT_Y = 0.03 * MODEL_SCALE;
const AI_HAND_CLOSER_OFFSET = -0.03 * MODEL_SCALE;
...
const AI_TOP_SIDE_HAND_UP_SHIFT_Y = 0.17 * MODEL_SCALE;
const AI_TOP_SIDE_HAND_OUTWARD_PUSH = 0.2 * MODEL_SCALE;
