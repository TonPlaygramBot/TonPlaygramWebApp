...
const HUMAN_HAND_CLOSER_OFFSET = -0.27 * MODEL_SCALE;
const HUMAN_HAND_BOTTOM_SHIFT_Y = -0.105 * MODEL_SCALE;
const HUMAN_HAND_LEFT_SHIFT = 0.115 * MODEL_SCALE;
...
const COMMUNITY_CARD_SPACING = CARD_W * COMMUNITY_CARD_SCALE * 1.16;
...
const COMMUNITY_CARD_CLOSER_TO_HUMAN = -0.12 * MODEL_SCALE;
const COMMUNITY_CARD_BOTTOM_SHIFT_Y = -0.03 * MODEL_SCALE;
const COMMUNITY_CARD_LEFT_SHIFT = 0.12 * MODEL_SCALE;
