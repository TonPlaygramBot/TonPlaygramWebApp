...
const HUMAN_CHARACTER_EXTRA_OUTWARD_OFFSET = 0.9; // push seated humans farther from the table for clearer portrait framing on portrait mobile
...
const HUMAN_CHAIR_EXTRA_OUTWARD_OFFSET = 0.96 * MODEL_SCALE; // Push human seat farther from table center (portrait visual direction).
