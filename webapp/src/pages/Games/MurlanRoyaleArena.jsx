...
const HUMAN_HAND_CLOSER_OFFSET = 0.22 * MODEL_SCALE; // Pull the bottom player's hand/cards further inward toward table center.
...
const HUMAN_CHAIR_EXTRA_INWARD_OFFSET = 1.24 * MODEL_SCALE; // Pull only the bottom player's chair closer to the table while preserving chair size.
