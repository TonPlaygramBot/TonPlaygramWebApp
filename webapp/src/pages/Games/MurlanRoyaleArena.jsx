...
const AI_TOP_HAND_EXTRA_OUTWARD_PUSH = 2.24 * MODEL_SCALE;
const AI_SIDE_HAND_UP_SHIFT_Y = -0.26 * MODEL_SCALE;
const AI_TOP_HAND_UP_SHIFT_Y = -0.04 * MODEL_SCALE;
const AI_SIDE_HAND_LATERAL_PALM_SHIFT = 0.07 * MODEL_SCALE;
const AI_SIDE_HAND_TOPWARD_SHIFT = 1.92 * MODEL_SCALE;
