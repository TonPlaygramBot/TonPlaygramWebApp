...
const HUMAN_HAND_FAN_ARC_LIFT = 0.024 * MODEL_SCALE;
...
const HUMAN_HAND_LEFT_SHIFT = -0.02 * MODEL_SCALE; // Negative value shifts the bottom human hand visually right toward the gift icon on portrait camera.
const AI_HAND_LEFT_SHIFT = 0;
const HUMAN_HAND_UP_SHIFT_Y = 0.116 * MODEL_SCALE;
