...
const CAMERA_SEATED_RETREAT_OFFSETS = Object.freeze({ portrait: -0.24 * ARENA_PROP_SCALE, landscape: 0.02 * ARENA_PROP_SCALE });
const CAMERA_SEATED_ELEVATION_OFFSETS = Object.freeze({
  portrait: 0.27 * ARENA_PROP_SCALE,
...
const HUMAN_HAND_EXTRA_LIFT = 0.042 * MODEL_SCALE;
...
const HUMAN_HAND_CLOSER_OFFSET = 0.08 * MODEL_SCALE; // Keep bottom-seat cards between chair and table edge while nudging them closer to table center.
const HUMAN_HAND_BOTTOM_SHIFT_Y = -0.46 * MODEL_SCALE;
const AI_HAND_BOTTOM_SHIFT_Y = -0.2 * MODEL_SCALE;
const AI_HAND_CLOSER_OFFSET = -0.24 * MODEL_SCALE;
...
const HUMAN_HAND_EXTRA_INWARD_PULL = 0.44 * MODEL_SCALE;
const AI_HAND_TABLE_EDGE_MARGIN = CARD_H * 0.24;
const HAND_CARDS_INWARD_BIAS = 0.28 * MODEL_SCALE;
...
const CAMERA_INWARD_RADIUS_FACTOR = 0.56 * ARENA_PROP_SCALE;
