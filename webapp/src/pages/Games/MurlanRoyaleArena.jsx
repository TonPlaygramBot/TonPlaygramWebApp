...
const CAMERA_SEATED_RETREAT_OFFSETS = Object.freeze({ portrait: 0.74, landscape: 0.62 });
...
const HUMAN_HAND_CLOSER_OFFSET = -0.22 * MODEL_SCALE;
const HUMAN_HAND_BOTTOM_SHIFT_Y = -0.08 * MODEL_SCALE;
const HUMAN_HAND_LEFT_SHIFT = 0.08 * MODEL_SCALE;
...
const COMMUNITY_CARD_CLOSER_TO_HUMAN = 0.14 * MODEL_SCALE;
