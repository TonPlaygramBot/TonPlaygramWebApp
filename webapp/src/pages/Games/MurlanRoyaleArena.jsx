...
const HUMAN_CHARACTER_EXTRA_OUTWARD_OFFSET = 0.82; // bring seated humans even closer to the table on portrait mobile framing.
...
function refreshRigHeldCards(rig, handCardsInput, playerColor, cardTheme, cardTextureSize = null) {
  ...
  nextCards.position.set(0.0 * MODEL_SCALE, 0.76 * MODEL_SCALE, 1.04 * MODEL_SCALE);
