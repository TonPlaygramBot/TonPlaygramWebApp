...
const AI_SIDE_HAND_EXTRA_OUTWARD_PUSH = 0.95 * MODEL_SCALE;
const AI_TOP_HAND_EXTRA_OUTWARD_PUSH = 1.32 * MODEL_SCALE;
const AI_SIDE_HAND_UP_SHIFT_Y = -0.12 * MODEL_SCALE;
const AI_TOP_HAND_UP_SHIFT_Y = 0.1 * MODEL_SCALE;
const AI_SIDE_HAND_LATERAL_PALM_SHIFT = 0.07 * MODEL_SCALE;
const AI_SIDE_HAND_TOPWARD_SHIFT = 0.98 * MODEL_SCALE;
