...
const HUMAN_HAND_CARD_SPACING = CARD_W * HUMAN_HAND_CARD_SCALE * 0.24;
const HUMAN_HAND_CARD_MAX_SPREAD = HUMAN_HAND_CARD_SPACING * 12;
const HUMAN_HAND_EXTRA_LIFT = 0.068 * MODEL_SCALE;
const HUMAN_HAND_FAN_MAX_YAW = THREE.MathUtils.degToRad(8);
const HUMAN_HAND_FAN_ARC_LIFT = 0.016 * MODEL_SCALE;
...
const HUMAN_HAND_LEFT_SHIFT = 0.08 * MODEL_SCALE; // Positive value shifts the bottom human hand visually left on portrait camera.
