...
const HUMAN_CHARACTER_EXTRA_LOWER_OFFSET = 0.16; // seat humans lower so hips/legs rest properly on the chair cushion.
const TOP_SEAT_AVATAR_UP_LIFT = 5.35;
const NON_HUMAN_SEAT_AVATAR_UP_LIFT = 1.2;
...
const HUMAN_HAND_CARD_SPACING = CARD_W * HUMAN_HAND_CARD_SCALE * 0.205;
const HUMAN_HAND_CARD_MAX_SPREAD = HUMAN_HAND_CARD_SPACING * 8.2;
...
const TOP_AI_HAND_CARD_SPACING_MULTIPLIER = 0.84;
const TOP_AI_HAND_CARD_MAX_SPREAD_MULTIPLIER = 0.8;
const SIDE_AI_HAND_CARD_SPACING_MULTIPLIER = 0.84;
const SIDE_AI_HAND_CARD_MAX_SPREAD_MULTIPLIER = 0.76;
...
const HUMAN_HAND_EXTRA_INWARD_PULL = 0.5 * MODEL_SCALE;
...
const HUMAN_CHAIR_EXTRA_OUTWARD_OFFSET = 0.6 * MODEL_SCALE; // pull the human seat a bit closer to the table on portrait framing.
