...
const CHAIR_INWARD_OFFSET = 0.34 * MODEL_SCALE; // Match Apr 19 spacing baseline while preserving current asset scale.
...
const HUMAN_HAND_CLOSER_OFFSET = -0.92 * MODEL_SCALE; // Restore Apr 19 hand/table spacing while keeping card/chair size unchanged.
...
const CHAIR_SCREEN_LOWER_OFFSET = 0.1 * MODEL_SCALE; // Keep the prior grounded look from the Apr 19 spacing pass.
const HUMAN_CHAIR_EXTRA_INWARD_OFFSET = 0.38 * MODEL_SCALE; // Preserve the former human-seat to table gap.
