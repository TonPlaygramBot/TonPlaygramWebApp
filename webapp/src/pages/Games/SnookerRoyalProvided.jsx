...
function createSnookerRulesState() {
  return { scores: [0, 0], score: 0, activePlayer: 0, targetKind: 1, target: 'Ball 1', foul: '', shotActive: false, shotPotCount: 0, shotFoul: '' };
}
...
export default function SnookerRoyalProvided({ gameTitle = 'Albanian Bilard Royal Provided' } = {}) {
