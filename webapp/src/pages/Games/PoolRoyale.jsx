...
const SIDE_POCKET_JAW_RADIUS_EXPANSION = 0.96; // slightly broaden the middle jaw arc radius so the side-pocket jaws read fuller
const SIDE_POCKET_JAW_DEPTH_EXPANSION = 1; // keep middle jaw depth identical to the corners
const SIDE_POCKET_JAW_VERTICAL_TWEAK = -TABLE.THICK * 0.02; // lower the middle jaw tops a touch so they sit deeper toward the cloth plane
...
const SIDE_POCKET_OUTWARD_BIAS = TABLE.THICK * 0.08; // push the middle pocket centres farther outward so they sit farther from the table midpoint
...
const SIDE_POCKET_MOUTH_REDUCTION_SCALE = 0.972; // trim the middle pocket mouth width further so the radius reads tighter than the corners
