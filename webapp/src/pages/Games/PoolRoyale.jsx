...
const CUSHION_EXTRA_LIFT = CLOTH_LIFT - CLOTH_DROP + MICRO_EPS; // raise cushion bases until they sit flush with the cloth surface
const CUSHION_HEIGHT_DROP = TABLE.THICK * 0.12; // preserve the lowered lip so the cushion tops stay aligned with the wooden rails
