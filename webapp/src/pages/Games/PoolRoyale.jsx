...
const SIDE_POCKET_MOUTH_REDUCTION_SCALE = 0.968; // tighten the middle pocket mouth further so the jaws read smaller
...
const SIDE_POCKET_CUT_SCALE = 0.934; // trim the middle cloth/rail cutouts even more so the apertures read tighter
