...
const CHROME_SIDE_POCKET_CUT_CENTER_PULL_SCALE = 0.034; // pull the middle chrome arch farther toward table centre for a tighter cut alignment
...
const SIDE_POCKET_JAW_OUTWARD_SHIFT = TABLE.THICK * 0.188; // pull the middle pocket jaws closer to centre for a tighter cut
