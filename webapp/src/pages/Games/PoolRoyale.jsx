...
const TABLE_SIZE_SHRINK = 0.782; // shrink the table footprint an additional 8% while preserving proportions
const TABLE_HEIGHT_BOOST = 1.06; // lift the overall table stack slightly so the frame reads taller on screen
...
const STANDING_VIEW_MARGIN_LANDSCAPE = 1.0016;
const STANDING_VIEW_MARGIN_PORTRAIT = 1.0012;
...
const RAIL_OVERHEAD_DISTANCE_BIAS = 1.02; // lift the overhead broadcast framing so both end pockets stay visible
