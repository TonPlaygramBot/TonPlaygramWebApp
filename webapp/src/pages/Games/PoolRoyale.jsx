...
const SIDE_POCKET_JAW_LATERAL_EXPANSION = 1.26; // trim the middle jaw reach further so it stops shorter at the wood/cloth gap while keeping the jaw radius
...
function Table3D(
  ...
  const gapStripePad = TABLE.THICK * 0.012;
