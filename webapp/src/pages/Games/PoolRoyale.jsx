...
const CHROME_CORNER_HEIGHT_SCALE = 1.035; // stretch short-side chrome plates so they cover the rail arch transition
const CHROME_SIDE_POCKET_RADIUS_SCALE = 0.992; // tighten the side pocket arch footprint for slimmer middle chrome cuts
...
const CHROME_SIDE_POCKET_CUT_SCALE = 0.988; // shrink side chrome/rail arches so pocket jaws follow a smaller cut
