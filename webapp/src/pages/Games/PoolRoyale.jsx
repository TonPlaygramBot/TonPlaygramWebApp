...
const CHROME_SIDE_PLATE_HEIGHT_SCALE = 2.964; // extend fascia reach so the middle pocket cut gains a broader surround on the remaining three sides (~20% extra over the last pass)
const CHROME_SIDE_PLATE_CENTER_TRIM_SCALE = 0; // keep the middle fascia centred on the pocket without carving extra relief
const CHROME_SIDE_PLATE_WIDTH_EXPANSION_SCALE = 2.455; // push fascia span farther along the side rails so the middle plates run deeper toward the corners without widening the rounded pocket edge (~20% further reach)
...
const CHROME_SIDE_PLATE_OUTWARD_SHIFT_SCALE = 0.0804; // push the side fascias farther from centre so their outer edge stays flush while widening the reveal (~20% extra to meet the wood curve start)
