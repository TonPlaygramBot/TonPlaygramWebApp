...
const DEFAULT_TABLE_FINISH_ID = 'walnut';

const TABLE_FINISHES = Object.freeze(
  buildWoodFinishMap({ defaultClothColor: 0x2b7e4f, makeColorPalette })
);

const TABLE_FINISH_OPTIONS = Object.freeze(
  WOOD_FINISH_PRESETS.map(({ id }) => TABLE_FINISHES[id]).filter(Boolean)
);
