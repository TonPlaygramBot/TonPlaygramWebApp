  ...
  useEffect(() => {
    ...
    try {
      ...
      const applyCueStickTransform = (tipTarget) => {
        ...
        const minButtHeight = TABLE_RAIL_TOP_Y + CUE_CLEARANCE_PADDING;
        if (TMP_VEC3_BUTT.y < minButtHeight) {
          const liftDelta = minButtHeight - TMP_VEC3_BUTT.y;
          cueStick.position.y += liftDelta;
          TMP_VEC3_BUTT.y += liftDelta;
        }
      };
