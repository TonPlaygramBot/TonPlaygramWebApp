...
const CHROME_SIDE_POCKET_CUT_CENTER_PULL_SCALE = -0.068; // push the middle chrome arch slightly outward so the rounded fascia cut follows the wider middle pocket placement
...
const WOOD_SIDE_POCKET_CUT_CENTER_OUTSET_SCALE = -0.06; // push the middle-pocket wood arch outward so the rounded cut follows the shifted side pocket
...
const SIDE_POCKET_JAW_OUTWARD_SHIFT = TABLE.THICK * 0.008; // push the middle pocket jaws farther outward so the rounded lips align with the shifted pocket centres
...
const SIDE_POCKET_OUTWARD_BIAS = BALL_R * 0.26; // push middle pocket centres farther outward so they sit clearly away from the field centre
const SIDE_POCKET_FIELD_PULL = BALL_R * 0.04; // reduce inward pull so the outward bias drives the centres closer to the rails
