...
const POCKET_JAW_CORNER_INNER_SCALE = 1.352; // further trim the inner lip while leaving the exterior edge untouched
const POCKET_JAW_SIDE_INNER_SCALE = 1.378; // further trim the middle pocket inner lip to match the lighter interior profile
...
const POCKET_JAW_EDGE_TAPER_SCALE = 0.22; // keep the centre mass intact while letting the outer edge slim only slightly toward each pocket shoulder
const POCKET_JAW_CENTER_TAPER_HOLD = 0.34; // extend the uniform centre section so the jaw thickness only eases once it nears the chrome plates
const POCKET_JAW_EDGE_TAPER_PROFILE_POWER = 1.2; // ease the taper even more gradually so the edge mirrors the photographed jaw profile
