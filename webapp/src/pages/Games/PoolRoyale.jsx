...
const RAIL_BROADCAST_CAMERA_HEIGHT = TABLE_Y + TABLE.THICK + BALL_R * 5.6; // lower the rail cam head so the table fills more of the frame
  ...
  useEffect(() => {
    ...
    try {
      ...
      const broadcastRig = createBroadcastCameras({
        floorY,
        cameraHeight: RAIL_BROADCAST_CAMERA_HEIGHT,
