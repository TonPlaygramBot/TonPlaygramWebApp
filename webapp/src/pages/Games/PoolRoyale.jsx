...
const CHROME_SIDE_PLATE_POCKET_SPAN_SCALE = 1.08; // widen the side fascia so the chrome stretches toward the cushions
...
const SIDE_POCKET_JAW_LATERAL_EXPANSION = CORNER_POCKET_JAW_LATERAL_EXPANSION; // mirror the corner jaw spread for the middle pockets
const SIDE_POCKET_JAW_RADIUS_EXPANSION = 1; // keep the middle jaw radius identical to the base corner specification
...
const SIDE_POCKET_EXTRA_SHIFT = BALL_R * 0.48; // push the middle chrome cut-outs slightly farther outward so the rounded jaws clear the rail trim while staying aligned with the fascia plates
