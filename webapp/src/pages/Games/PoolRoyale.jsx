...
const CHROME_SIDE_POCKET_CUT_CENTER_PULL_SCALE = 0.18; // ease the middle chrome arch pull so the rounded fascia cut lands slightly farther outboard
...
const WOOD_SIDE_POCKET_CUT_CENTER_OUTSET_SCALE = 0.06; // relax the middle-pocket wood arch pull so the rounded rail cut shifts outward with the chrome
...
const SIDE_POCKET_OUTWARD_BIAS = BALL_R * 0.2; // push middle pocket centres farther outward so they sit farther from the field centre
const SIDE_POCKET_FIELD_PULL = BALL_R * 0.05; // ease the inward pull so the outward bias can push the centres farther toward the rails
