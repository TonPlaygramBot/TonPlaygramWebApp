...
function Table3D(
  ...
  const SIDE_CUSHION_POCKET_REACH_REDUCTION = TABLE.THICK * 0.036; // trim the side cushions a touch more so the noses stay clear as they enter the middle pockets
