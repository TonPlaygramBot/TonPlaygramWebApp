...
const CHROME_SIDE_POCKET_CUT_SCALE = 1.02; // trim the middle chrome arch so the rounded cut reads tighter instead of widening further inboard
const CHROME_SIDE_POCKET_CUT_CENTER_PULL_SCALE = 0.16; // ease the centre pull so the chrome cut stays closer to the rail while tracking the shifted pocket
...
const WOOD_SIDE_POCKET_CUT_CENTER_OUTSET_SCALE = 0.08; // nudge the middle-pocket wood arch only slightly toward centre so the rounded cut sits nearer the rail
...
const SIDE_POCKET_OUTWARD_BIAS = BALL_R * 0.22; // push middle pocket centres farther outward so they sit noticeably away from the field centre
const SIDE_POCKET_FIELD_PULL = BALL_R * 0.04; // reduce the inward pull so the outward bias can push the centres farther toward the rails
...
const SIDE_POCKET_MOUTH_REDUCTION_SCALE = 0.972; // further tighten the middle pocket mouth so the jaws read smaller
...
const SIDE_POCKET_CUT_SCALE = 0.93; // trim the middle cloth/rail cutouts even more so the apertures read tighter
