...
const CHROME_CORNER_SHORT_RAIL_CENTER_PULL_SCALE = 0.032; // nudge corner chrome plates toward the centre of each short rail
...
const CHROME_SIDE_NOTCH_DEPTH_SCALE = 1.01; // ease the middle chrome arch farther from centre while keeping the pocket origin fixed
...
const CHROME_SIDE_PLATE_POCKET_SPAN_SCALE = 1.015; // stretch the chrome arch slightly wider so the middle pockets sit farther from centre
...
const CHROME_SIDE_PLATE_WIDTH_EXPANSION_SCALE = 0.018; // widen the middle chrome fascia to follow the pushed-out pocket arc
...
function Table3D(
  ...
  const SIDE_CUSHION_CORNER_SHIFT = BALL_R * 0.38; // nudge the side cushions closer to the middle pockets
