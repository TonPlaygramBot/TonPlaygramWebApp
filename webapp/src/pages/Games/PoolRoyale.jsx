...
const CHROME_CORNER_NOTCH_CENTER_SCALE = 1.28; // pull chrome arches further toward the table centre
...
const CHROME_CORNER_WIDTH_SCALE = 1.2;
const CHROME_CORNER_HEIGHT_SCALE = 1.2;
...
const CHROME_CORNER_CENTER_PUSH_SCALE = 0.32; // push corner chrome plates farther from centre while narrowing their arches
