...
const CHROME_CORNER_FIELD_CLIP_WIDTH_SCALE = 0.9; // reuse snooker notch scoops so chrome never overhangs the cloth
const CHROME_CORNER_FIELD_CLIP_DEPTH_SCALE = 1.1; // mirror snooker's pocket depth relief
const CHROME_CORNER_FIELD_FILLET_SCALE = 1; // disable extra fillet so the chrome curvature matches snooker
const CHROME_CORNER_FIELD_EXTENSION_SCALE = 0; // keep fascia depth identical to snooker
const CHROME_CORNER_NOTCH_EXPANSION_SCALE = 1.015; // identical chrome cut growth as snooker
const CHROME_CORNER_DIMENSION_SCALE = 0.99; // ensure each chrome corner plate mirrors snooker proportions
const CHROME_CORNER_WIDTH_SCALE = CHROME_CORNER_DIMENSION_SCALE;
const CHROME_CORNER_HEIGHT_SCALE = CHROME_CORNER_DIMENSION_SCALE;
...
const CHROME_SIDE_PLATE_POCKET_SPAN_SCALE = 1.4; // identical span factor used by snooker
...
const POCKET_JAW_SIDE_OUTER_LIMIT_SCALE = 1.03; // let the middle jaw ride the expanded chrome/wood arc without leaving a gap
...
const SIDE_POCKET_JAW_LATERAL_EXPANSION = 1.1; // stretch the side jaw span so its shoulders seal against the rail cutouts
const SIDE_POCKET_JAW_RADIUS_EXPANSION = 1.02; // gently expand the jaw footprint to blanket the rounded rail relief
