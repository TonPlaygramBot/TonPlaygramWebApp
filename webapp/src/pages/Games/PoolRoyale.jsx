...
const POCKET_JAW_CORNER_INNER_SCALE = 1.368; // shave the inner lip a touch more so the pocket opening reads leaner without flattening the chrome-facing radius
const POCKET_JAW_SIDE_INNER_SCALE = 1.398; // mirror the leaner interior profile on the middle pockets while keeping the outer curve intact
