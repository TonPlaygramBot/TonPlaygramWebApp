...
const POCKET_JAW_EDGE_TAPER_SCALE = 0.16; // keep the centre mass intact while letting the outer edge slim more toward each pocket shoulder
const POCKET_JAW_CENTER_TAPER_HOLD = 0.28; // extend the uniform centre section so the jaw thickness only eases once it nears the chrome plates
