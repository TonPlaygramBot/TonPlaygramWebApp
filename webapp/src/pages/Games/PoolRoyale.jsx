...
const POCKET_JAW_CORNER_OUTER_LIMIT_SCALE = 1.026; // let the corner jaws reach the cushions without leaving a sliver
...
const POCKET_JAW_CORNER_EDGE_FACTOR = 0.42; // reference factor for the chamfer along the corner jaw shoulders
const POCKET_JAW_SIDE_EDGE_FACTOR = 0.42; // thicker side jaw shoulders to match the beefier Pool Royale liners
const POCKET_JAW_CORNER_MIDDLE_FACTOR = 0.955; // keep the centre mass similar to the snooker reference
...
const CORNER_POCKET_JAW_LATERAL_EXPANSION = 1.62; // align the corner jaw spread with the snooker chrome cut geometry
...
const CORNER_POCKET_CENTER_INSET =
  POCKET_VIS_R * 0.045 * POCKET_VISUAL_EXPANSION; // pull every corner pocket centre a hair toward the table middle
