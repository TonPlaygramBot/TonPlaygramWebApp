...
const CUSHION_EXTRA_LIFT = -TABLE.THICK * 0.064; // sink the cushion base modestly so the pads stay near the rail line
const CUSHION_HEIGHT_DROP = TABLE.THICK * 0.182; // trim the cushion tops further so their surface levels cleanly with the rails
