...
const POCKET_JAW_CORNER_INNER_SCALE = 1.395; // slim the inner lip slightly while leaving the exterior edge untouched
const POCKET_JAW_SIDE_INNER_SCALE = 1.421; // slim the middle pocket inner lip to match the lighter interior profile
