...
function Table3D(
  ...
  const SIDE_CUSHION_POCKET_REACH_REDUCTION = TABLE.THICK * 0.9; // trim the side cushions further so the tips finish exactly where the rounded pocket cuts begin
