...
const CHROME_SIDE_POCKET_CUT_CENTER_PULL_SCALE = -0.004; // pull the middle chrome arch fractionally toward table centre
...
const SIDE_POCKET_OUTWARD_BIAS = BALL_R * 0.98; // push middle pocket centres farther from table centre without moving the rail cut arcs
