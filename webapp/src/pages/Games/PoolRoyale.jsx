...
const CHROME_SIDE_PLATE_HEIGHT_SCALE = 3.12; // extend fascia reach so the middle pocket cut gains a noticeably broader surround on the remaining three sides
const CHROME_SIDE_PLATE_CENTER_TRIM_SCALE = 0; // keep the middle fascia centred on the pocket without carving extra relief
const CHROME_SIDE_PLATE_WIDTH_EXPANSION_SCALE = 2.34; // push fascia span farther along the side rails so the middle plates run even deeper toward the corners without widening the rounded pocket edge
const CHROME_SIDE_PLATE_WIDTH_REDUCTION_SCALE = 1.05; // stop trimming the fascia beside middle pockets and allow a slight boost so the surround grows on both sides of the cut
