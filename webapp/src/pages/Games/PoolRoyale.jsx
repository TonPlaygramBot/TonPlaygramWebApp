...
const CHROME_SIDE_POCKET_CUT_SCALE = 1.012; // open the middle chrome arch slightly wider so the rounded cut reads a touch larger
const CHROME_SIDE_POCKET_CUT_CENTER_PULL_SCALE = -0.012; // ease the offset so the middle chrome arch sits a bit closer to table centre
...
const SIDE_POCKET_OUTWARD_BIAS = BALL_R * 0.48; // push middle pocket centres farther from table centre without moving the rail cut arcs
