...
const CUSHION_EXTRA_LIFT = -TABLE.THICK * 0.138; // sink the cushion base further so the pads settle slightly below the rail line
...
function Table3D(
  ...
  const SIDE_CUSHION_POCKET_REACH_REDUCTION = TABLE.THICK * 0.026; // trim the side cushions slightly so the tips no longer protrude into the pocket mouths
