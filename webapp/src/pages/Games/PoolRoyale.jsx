...
const POCKET_JAW_CORNER_TRIM_RATIO = 0.3451; // trim the corner jaw wings so each covers roughly 15% less of the pocket perimeter
...
const POCKET_JAW_CORNER_SIDE_TRIM_OFFSET =
  POCKET_VIS_R * 0.006375 * POCKET_VISUAL_EXPANSION; // narrow the diagonal trims to match the new 15% shorter corner jaw coverage
const POCKET_JAW_CORNER_LIMIT_OFFSET =
  POCKET_VIS_R * 0.01326 * POCKET_VISUAL_EXPANSION; // pull the corner jaw lips back so they only cover roughly 15% less of each pocket
...
function Table3D(
  ...
  const cushionRailReachX = Math.max(
    0,
