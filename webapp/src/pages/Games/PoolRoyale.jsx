...
const SIDE_POCKET_JAW_RADIUS_EXPANSION = 1.02; // round the middle jaw arc a touch wider so side-pocket cuts read with a broader radius
...
const CLOTH_QUALITY = (() => {
  ...
  if (isMobileUA || isTouch || lowMemory || lowRefresh) {
    ...
    return {
      textureSize: highDensity ? 1984 : 1472,
      anisotropy: highDensity ? 22 : 16,
      generateMipmaps: true,
      bumpScaleMultiplier: highDensity ? 1 : 0.92,
      sheen: 0.82,
      sheenRoughness: 0.8
    };
  }
...
const FRAME_RATE_OPTIONS = Object.freeze([
  {
    ...
    description: 'Sharper HD output for efficiency-first and 60 Hz displays.'
  },
  {
    id: 'fhd60',
    label: 'Full HD+ (90 Hz)',
    ...
    description: '90 Hz baseline that mirrors Snooker pacing with added sharpness.'
  },
  {
    id: 'qhd90',
