...
const CUSHION_EXTRA_LIFT = Math.max(0, CLOTH_LIFT - CLOTH_DROP); // raise cushion bases until they sit flush with the cloth
const CUSHION_HEIGHT_DROP = 0; // keep cushion lips aligned with the top surface of the wooden rails
