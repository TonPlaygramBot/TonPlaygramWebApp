...
const CHROME_CORNER_SIDE_EXPANSION_SCALE = CHROME_CORNER_EXPANSION_SCALE; // keep both chrome edges perfectly symmetrical against the cushions
...
const CHROME_CORNER_FIELD_EXTENSION_SCALE = 0.42; // stretch the chrome fascia deeper so it fully reaches the pocket liner
const CHROME_CORNER_NOTCH_EXPANSION_SCALE = 1.01; // grow the inner cut slightly so no chrome lip creeps onto the cloth
const CHROME_CORNER_DIMENSION_SCALE = 0.97; // ensure each chrome corner plate is scaled identically along both axes
