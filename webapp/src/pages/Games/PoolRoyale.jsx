...
const SIDE_POCKET_JAW_LATERAL_EXPANSION = 1.33; // trim middle jaw reach so fascia stops at the wood rail edge while keeping the jaw radius
...
function Table3D(
  ...
  const gapStripePad = TABLE.THICK * 0.012; // push the gap stripe outward so it sits centered in the rail/cushion gap
