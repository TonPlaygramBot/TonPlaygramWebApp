...
const CHROME_SIDE_PLATE_WIDTH_EXPANSION_SCALE = 1.573; // stretch fascia span farther along the side rails with roughly 30% more reveal away from the cut
const CHROME_SIDE_PLATE_CORNER_BIAS_SCALE = 0.804; // bias the side chrome growth toward the corner pockets only
const CHROME_SIDE_PLATE_CORNER_LIMIT_SCALE = 0.04;
const CHROME_SIDE_PLATE_OUTWARD_SHIFT_SCALE = 0.052; // push the side fascias slightly farther from centre so their outer edge stays flush while widening the reveal
...
const CHROME_SIDE_POCKET_CUT_SCALE = 1.038; // widen and deepen the middle chrome arch so the rounded cut opens up while sitting further inboard
const CHROME_SIDE_POCKET_CUT_CENTER_PULL_SCALE = 0.256; // pull the middle chrome arch farther toward centre so the rounded fascia cut tracks the shifted pocket more aggressively
