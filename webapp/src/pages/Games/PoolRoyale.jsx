...
const CHROME_CORNER_EXPANSION_SCALE = 0.0507; // trim the long-rail chrome edge so it stops exactly where the cushion nose ends
...
const CHROME_CORNER_WIDTH_SCALE = 0.976;
const CHROME_CORNER_HEIGHT_SCALE = 0.976;
