...
const CHROME_SIDE_PLATE_POCKET_SPAN_SCALE = 1.6; // ease the side plate span so chrome no longer lingers on the playfield edge
...
function Table3D(
  ...
  const chromePlateThickness = railH * 0.165; // trim the corner chrome depth so it follows the tighter pocket cut
