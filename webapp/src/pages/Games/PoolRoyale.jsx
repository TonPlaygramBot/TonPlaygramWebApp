...
const CHROME_CORNER_POCKET_CUT_SCALE = 1; // chrome trace follows the pocket jaws exactly
const CHROME_SIDE_POCKET_CUT_SCALE = 1; // middle chrome cut now matches the pocket jaws 1:1
