...
const CHROME_CORNER_FIELD_EXTENSION_SCALE = 0.08; // push the chrome fascia farther so it meets the pocket liner
...
const CHROME_CORNER_HEIGHT_SCALE = 0.963;
...
// angle for cushion cuts guiding balls into pockets (Pool Royale spec requires 35°)
