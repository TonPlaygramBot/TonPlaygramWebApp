...
const WOOD_SIDE_RAIL_POCKET_RELIEF_SCALE = 1.012; // match the middle rail arch relief to the chrome cut so the rounded openings align in size
const WOOD_SIDE_POCKET_CUT_CENTER_OUTSET_SCALE = 0.012; // pull the wooden middle-pocket relief to the same centre offset as the chrome arch
...
const SIDE_POCKET_JAW_LATERAL_EXPANSION =
  CORNER_POCKET_JAW_LATERAL_EXPANSION * 1.04; // push the middle jaw shoulders outward so they sit farther from table centre
