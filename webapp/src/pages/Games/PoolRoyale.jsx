...
export function applySnookerScaling({
  tableInnerRect,
  cushions,
  pockets,
  balls,
...
export const POOL_ROYALE_TABLE_GEOMETRY = Object.freeze({
  POCKET_VISUAL_EXPANSION,
  CHROME_CORNER_POCKET_RADIUS_SCALE,
  CHROME_CORNER_NOTCH_CENTER_SCALE,
  CHROME_CORNER_EXPANSION_SCALE,
  CHROME_CORNER_SIDE_EXPANSION_SCALE,
  CHROME_CORNER_FIELD_TRIM_SCALE,
  CHROME_CORNER_NOTCH_WEDGE_SCALE,
  CHROME_CORNER_FIELD_CLIP_WIDTH_SCALE,
  CHROME_CORNER_FIELD_CLIP_DEPTH_SCALE,
  CHROME_CORNER_FIELD_FILLET_SCALE,
  CHROME_CORNER_FIELD_EXTENSION_SCALE,
  CHROME_CORNER_NOTCH_EXPANSION_SCALE,
  CHROME_CORNER_DIMENSION_SCALE,
  CHROME_CORNER_WIDTH_SCALE,
  CHROME_CORNER_HEIGHT_SCALE,
  CHROME_CORNER_CENTER_OUTSET_SCALE,
  CHROME_CORNER_SHORT_RAIL_SHIFT_SCALE,
  CHROME_CORNER_SHORT_RAIL_CENTER_PULL_SCALE,
  CHROME_CORNER_EDGE_TRIM_SCALE,
  CHROME_SIDE_POCKET_RADIUS_SCALE,
  WOOD_RAIL_CORNER_RADIUS_SCALE,
  CHROME_SIDE_NOTCH_THROAT_SCALE,
  CHROME_SIDE_NOTCH_HEIGHT_SCALE,
  CHROME_SIDE_NOTCH_RADIUS_SCALE,
  CHROME_SIDE_NOTCH_DEPTH_SCALE,
  CHROME_SIDE_FIELD_PULL_SCALE,
  CHROME_PLATE_THICKNESS_SCALE,
  CHROME_PLATE_RENDER_ORDER,
  CHROME_SIDE_PLATE_POCKET_SPAN_SCALE,
  CHROME_SIDE_PLATE_HEIGHT_SCALE,
  CHROME_SIDE_PLATE_CENTER_TRIM_SCALE,
  CHROME_SIDE_PLATE_WIDTH_EXPANSION_SCALE,
  CHROME_SIDE_PLATE_CORNER_LIMIT_SCALE,
  CHROME_OUTER_FLUSH_TRIM_SCALE,
  CHROME_CORNER_POCKET_CUT_SCALE,
  CHROME_SIDE_POCKET_CUT_SCALE,
  CHROME_SIDE_POCKET_CUT_CENTER_PULL_SCALE,
  WOOD_RAIL_POCKET_RELIEF_SCALE,
  WOOD_CORNER_RELIEF_INWARD_SCALE,
  WOOD_CORNER_RAIL_POCKET_RELIEF_SCALE,
  ...
  POCKET_JAW_CORNER_OUTER_SCALE,
  POCKET_JAW_SIDE_OUTER_SCALE,
  POCKET_JAW_CORNER_OUTER_EXPANSION,
  SIDE_POCKET_JAW_OUTER_EXPANSION,
  POCKET_JAW_DEPTH_SCALE,
  POCKET_JAW_VERTICAL_LIFT,
  POCKET_JAW_BOTTOM_CLEARANCE,
  POCKET_JAW_EDGE_FLUSH_START,
  POCKET_JAW_EDGE_FLUSH_END,
  POCKET_JAW_EDGE_TAPER_SCALE,
  POCKET_JAW_CENTER_THICKNESS_MIN,
  ...
  POCKET_JAW_INNER_EXPONENT_MIN,
  POCKET_JAW_INNER_EXPONENT_MAX,
  POCKET_JAW_SEGMENT_MIN,
  SIDE_POCKET_JAW_LATERAL_EXPANSION,
  SIDE_POCKET_JAW_RADIUS_EXPANSION,
  SIDE_POCKET_JAW_DEPTH_EXPANSION,
  SIDE_POCKET_JAW_SIDE_TRIM_SCALE,
  SIDE_POCKET_JAW_MIDDLE_TRIM_SCALE,
  CORNER_POCKET_JAW_LATERAL_EXPANSION,
  CORNER_JAW_ARC_DEG,
  SIDE_JAW_ARC_DEG,
  TABLE_SIZE_SHRINK,
  TABLE_REDUCTION,
  ...
  BALL_D_REF,
  BALL_SIZE_SCALE,
  BAULK_FROM_BAULK_REF,
  D_RADIUS_REF,
  BLACK_FROM_TOP_REF,
  CORNER_MOUTH_REF,
  SIDE_MOUTH_REF,
  CORNER_POCKET_SCALE_BOOST,
  SIDE_POCKET_MOUTH_REDUCTION_SCALE,
  SIDE_RAIL_INNER_REDUCTION,
  SIDE_RAIL_INNER_SCALE,
  SIDE_RAIL_INNER_THICKNESS,
  TARGET_RATIO,
  END_RAIL_INNER_SCALE,
  END_RAIL_INNER_REDUCTION,
  END_RAIL_INNER_THICKNESS,
  ORIGINAL_PLAY_W,
  ORIGINAL_HALF_W,
  ORIGINAL_PLAY_H,
  ORIGINAL_HALF_H,
  ORIGINAL_OUTER_HALF_W,
  ORIGINAL_OUTER_HALF_H,
  PLAY_W,
  PLAY_H,
  MM_TO_UNITS,
  BALL_DIAMETER,
