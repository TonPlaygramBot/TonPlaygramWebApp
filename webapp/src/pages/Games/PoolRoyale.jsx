...
const TOP_VIEW_SCREEN_OFFSET = Object.freeze({
  ...
  z: BALL_R * 1.9 // lift the table toward the top edge for 2D mode (pull a bit higher)
});
...
const RAIL_OVERHEAD_DISTANCE_BIAS = 1.14; // pull the rail overhead broadcast heads slightly away from the cloth for fuller pocket coverage
