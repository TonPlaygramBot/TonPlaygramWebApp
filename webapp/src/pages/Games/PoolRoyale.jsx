...
const SIDE_POCKET_JAW_OUTWARD_SHIFT = TABLE.THICK * 0.15; // push the middle pocket jaws further outward from the table centre so the jaws sit visibly outside the midpoint
