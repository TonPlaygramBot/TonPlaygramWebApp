...
const CLOTH_BUMP_INTENSITY = 2.25;
...
const CLOTH_PATTERN_SCALE = 0.6; // enlarge the cloth pattern so the weave reads clearly on mobile
const CLOTH_TEXTURE_REPEAT_HINT = 1.52;
const POLYHAVEN_PATTERN_REPEAT_SCALE = 1 / 3;
const POLYHAVEN_ANISOTROPY_BOOST = 2.6;
const CLOTH_NORMAL_SCALE = new THREE.Vector2(2.4, 1.15);
