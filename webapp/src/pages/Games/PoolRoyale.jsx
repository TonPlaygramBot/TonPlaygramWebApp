...
const CUSHION_HEIGHT_DROP = 0; // keep the cushion lip perfectly level with the surrounding wooden rails
...
function Table3D(
  ...
  const CUSHION_UNDERCUT_BASE_LIFT = 0; // keep the underside seated directly on the cloth so the cushions don't dip below the field
  const CUSHION_RAIL_BASE_LIFT = 0; // keep the cushion base flush with the cloth plane along the wooden rails
  const CUSHION_UNDERCUT_FRONT_REMOVAL = 0; // preserve the triangular nose profile while keeping the base at the cloth level
