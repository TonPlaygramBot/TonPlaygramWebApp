...
function Table3D(
  ...
  const shadowCoverMat = clothMat.clone();
  shadowCoverMat.color.copy(clothColor.clone().lerp(new THREE.Color(0x000000), 0.16));
  shadowCoverMat.map = null;
  shadowCoverMat.bumpMap = null;
  shadowCoverMat.bumpScale = 0;
  shadowCoverMat.metalness = 0;
  shadowCoverMat.roughness = 1;
  shadowCoverMat.clearcoat = 0;
  shadowCoverMat.clearcoatRoughness = 1;
  shadowCoverMat.envMapIntensity = 0;
  shadowCoverMat.sheen = 0;
  shadowCoverMat.reflectivity = 0;
  shadowCoverMat.emissive.set(0x000000);
  shadowCoverMat.emissiveIntensity = 0;
  shadowCoverMat.side = THREE.DoubleSide;
  shadowCoverMat.transparent = false;
  shadowCoverMat.opacity = 1;
  shadowCoverMat.depthWrite = true;
  shadowCoverMat.colorWrite = true;
