...
function Table3D(
  ...
  const SIDE_CUSHION_POCKET_REACH_REDUCTION = TABLE.THICK * 0.16; // trim the side cushions more aggressively so the tips end where the rounded cut begins
  const SIDE_CUSHION_RAIL_REACH = TABLE.THICK * 0.034; // press the side cushions firmly into the rails without creating overlap
  const SIDE_CUSHION_CORNER_SHIFT = BALL_R * 0.08; // keep the side cushion ends symmetrical at the start of the pocket jaw radius
