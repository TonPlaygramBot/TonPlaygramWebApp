...
const POCKET_JAW_CORNER_INNER_SCALE = 1.456; // pull the inner lip slightly outward so the jaw thins from the pocket side while keeping the chrome-facing radius and exterior fascia untouched
const POCKET_JAW_SIDE_INNER_SCALE = 1.486; // mirror the leaner interior profile on the middle pockets so the jaws slim inside without altering the outer curve or chrome alignment
