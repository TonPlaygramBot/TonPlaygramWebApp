...
const SIDE_POCKET_MOUTH_REDUCTION_SCALE = 0.992; // pinch the middle pocket mouth slightly so the jaws read tighter without upsetting balance
...
const SIDE_POCKET_CUT_SCALE = 0.962; // trim the middle cloth/rail cutouts a bit further to tighten the visual aperture
