...
const CHROME_CORNER_FIELD_EXTENSION_SCALE = 0.03;
...
const CHROME_CORNER_CENTER_PUSH_SCALE = 0.12; // slide corner chrome plates farther from centre without disturbing the pocket arch
