...
const POCKET_JAW_CORNER_OUTER_LIMIT_SCALE = 1; // match the snooker chrome plate layout exactly
const POCKET_JAW_SIDE_OUTER_LIMIT_SCALE = 1; // align middle jaws with the snooker chrome geometry
const POCKET_JAW_CORNER_INNER_SCALE = 1.11; // ease the inner lip outward so the jaw sits a touch farther from centre
const POCKET_JAW_SIDE_INNER_SCALE = 0.962; // mirror the snooker jaw pull-in so the liners sit identically
const POCKET_JAW_CORNER_OUTER_SCALE = 1.723; // preserve the playable mouth with the snooker fascia profile
const POCKET_JAW_SIDE_OUTER_SCALE = 1.78; // keep the side mouth consistent with the snooker chrome-backed arch
...
const SIDE_POCKET_JAW_LATERAL_EXPANSION = 0.9; // side jaws now keep a single arc that matches the pocket diameter
const SIDE_POCKET_JAW_RADIUS_EXPANSION = 0.92; // jaw footprint mirrors the pocket cut with no additional widening
...
const SIDE_POCKET_EXTRA_SHIFT = 0; // keep middle pocket centres aligned exactly with the snooker reference
...
const CORNER_POCKET_CENTER_INSET = 0; // corner pocket centres match the snooker layout one-to-one
