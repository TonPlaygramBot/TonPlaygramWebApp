...
const CHROME_SIDE_PLATE_HEIGHT_SCALE = 2.82; // extend fascia reach so the middle pocket cut gains a broader surround on the remaining three sides (~37% boost)
const CHROME_SIDE_PLATE_CENTER_TRIM_SCALE = 0; // keep the middle fascia centred on the pocket without carving extra relief
const CHROME_SIDE_PLATE_WIDTH_EXPANSION_SCALE = 2.24; // broaden the fascia span so the middle plates mirror the corner coverage while keeping the rounded edge intact
...
const CHROME_SIDE_PLATE_WIDTH_REDUCTION_SCALE = 1; // keep the widened fascia flanks fully extended while staying inside the pocket reveal
...
const CHROME_SIDE_PLATE_OUTWARD_SHIFT_SCALE = 0.14; // push the side fascias farther outward so their outer edge follows the relocated middle pocket cuts
...
const SIDE_POCKET_JAW_VERTICAL_TWEAK = TABLE.THICK * 0.024; // lift the middle jaws so they sit directly under the cloth like the corner pockets
...
const SIDE_POCKET_OUTWARD_BIAS = TABLE.THICK * 0.052; // push the middle pocket centres and cloth cutouts farther outward to align with the rail cuts
const SIDE_POCKET_FIELD_PULL = TABLE.THICK * 0.028; // gently bias the middle pocket centres and cuts back toward the playfield after the outward shift
