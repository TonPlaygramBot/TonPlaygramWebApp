...
const CHROME_SIDE_PLATE_WIDTH_EXPANSION_SCALE = 2.5; // push the middle fascias farther outward so their span blankets the wooden rails like the wider corner plates
...
const CHROME_SIDE_PLATE_OUTWARD_SHIFT_SCALE = 0; // keep side fascias flush so the outer edge fully blankets the wooden rails
