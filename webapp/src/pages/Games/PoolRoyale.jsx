...
const CHROME_CORNER_CENTER_OUTSET_SCALE = 0.2; // push the corner chrome plates farther outward to widen the centre gap and leave more distance from the centre line
