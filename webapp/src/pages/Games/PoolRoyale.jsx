...
const CHROME_SIDE_PLATE_WIDTH_EXPANSION_SCALE = 0.74; // extend fascia span toward the corners without widening the inner edge
...
const CHROME_SIDE_POCKET_CUT_SCALE = 1.042; // open the middle chrome arch slightly wider so the rounded cut reads a touch larger
const CHROME_SIDE_POCKET_CUT_CENTER_PULL_SCALE = 0.006; // push the middle chrome arch fractionally outward from table centre
...
const SIDE_POCKET_EXTRA_SHIFT = BALL_R * 2.08; // ease the middle pockets closer to centre while keeping them snug against the chrome hook
const SIDE_POCKET_OUTWARD_BIAS = BALL_R * 0.72; // push middle pocket centres farther from table centre without moving the rail cut arcs
...
const SIDE_POCKET_CUT_SCALE = 1.07; // enlarge only the middle cloth cutouts so chrome and wooden rail arcs stay unchanged
