...
const CHROME_CORNER_NOTCH_CENTER_SCALE = 1.01; // nudge the rounded chrome cut slightly toward the playing field
...
const CHROME_SIDE_PLATE_POCKET_SPAN_SCALE = 1.008; // stretch the chrome arch slightly wider so the middle pockets sit farther from centre
...
const CHROME_SIDE_PLATE_WIDTH_EXPANSION_SCALE = 0.012; // widen the middle chrome fascia to follow the pushed-out pocket arc
...
const SIDE_POCKET_JAW_LATERAL_EXPANSION = 1.12; // give the widened middle pocket arc a touch more jaw coverage
const SIDE_POCKET_JAW_RADIUS_EXPANSION = 1; // keep the side jaw radius identical to the chrome/rail pocket arc
