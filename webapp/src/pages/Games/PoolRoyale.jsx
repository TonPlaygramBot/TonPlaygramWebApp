...
const POCKET_JAW_CORNER_INNER_SCALE = 1.436; // tuck the inner lip further so the pocket opening thins slightly while keeping the chrome-facing radius and exterior fascia untouched
const POCKET_JAW_SIDE_INNER_SCALE = 1.466; // mirror the leaner interior profile on the middle pockets without altering the outer curve or chrome alignment
