...
const CUSHION_EXTRA_LIFT = -TABLE.THICK * 0.062; // sink the cushion base only slightly so the pad height can sit level with the rails
const CUSHION_HEIGHT_DROP = TABLE.THICK * 0.182; // trim more off the cushion tops so their surface meets the wooden rails cleanly
