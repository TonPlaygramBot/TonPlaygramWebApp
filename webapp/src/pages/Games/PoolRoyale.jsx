...
const CHROME_CORNER_POCKET_CUT_SCALE = 1.018; // open the corner chrome cut a touch further so the rounded pocket reveal grows
...
const POCKET_JAW_CORNER_INNER_SCALE = 1.443; // pull the inner lip outward so the jaw thickness drops roughly 50%
