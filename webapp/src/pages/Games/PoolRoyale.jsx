...
const SIDE_POCKET_JAW_RADIUS_EXPANSION = 0.94; // tighten the middle jaw arc radius so side-pocket jaws sit slimmer and read smaller
...
function Table3D(
  ...
  const gapStripeOutwardShift = TABLE.THICK * 0.028;
