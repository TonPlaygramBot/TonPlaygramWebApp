...
function Table3D(
  ...
  const SIDE_CUSHION_POCKET_REACH_REDUCTION = TABLE.THICK * 0.12; // trim the side cushions slightly shorter at the middle pockets so the noses stay clear of the pocket interior
