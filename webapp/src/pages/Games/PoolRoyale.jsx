...
const CUSHION_EXTRA_LIFT = -TABLE.THICK * 0.145; // sink the cushion base further so the pads settle slightly below the rail line
const CUSHION_HEIGHT_DROP = TABLE.THICK * 0.145; // trim the cushion tops more so chalks and diamonds stay visible above the pads
...
function Table3D(
  ...
  const SIDE_CUSHION_POCKET_REACH_REDUCTION = TABLE.THICK * 0.05; // trim the side cushions further so the tips no longer protrude into the pocket mouths
