...
const SIDE_POCKET_JAW_LATERAL_EXPANSION = 1.398; // pull the middle jaw span slightly tighter so the fascia clears the rounded rail cut
const SIDE_POCKET_JAW_RADIUS_EXPANSION = 0.978; // shave the middle jaw radius a touch more so the pocket mouth presents narrower than before
