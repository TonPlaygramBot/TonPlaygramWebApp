...
const SIDE_POCKET_JAW_LATERAL_EXPANSION = 1.29; // let the middle jaws run a hair broader so they present slightly larger while closing the reach gap
const SIDE_POCKET_JAW_RADIUS_EXPANSION = 0.985; // gently widen the middle jaw arc radius so the fascia reads a touch fuller
...
const SIDE_POCKET_MOUTH_REDUCTION_SCALE = 0.956; // shrink the middle pocket mouth width further so it matches the corner pocket span
...
const SIDE_POCKET_CUT_SCALE = 0.95; // tighten the middle cloth/rail cutouts so the apertures align to the now-narrower mouth
