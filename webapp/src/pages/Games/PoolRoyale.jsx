...
const CHROME_SIDE_POCKET_CUT_SCALE = 1.02; // tuck the middle chrome arch slightly further inboard so the rounded cut sits deeper within the fascia
const CHROME_SIDE_POCKET_CUT_CENTER_PULL_SCALE = 0.22; // pull the middle chrome arch farther toward centre so the rounded fascia cut tracks the shifted pocket more aggressively
