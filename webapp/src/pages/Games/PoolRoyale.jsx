...
const CUSHION_EXTRA_LIFT = -TABLE.THICK * 0.135; // sink the cushion base a touch further so the pads settle slightly below the rail line
const CUSHION_HEIGHT_DROP = TABLE.THICK * 0.14; // trim the cushion tops a bit more so chalks and diamonds stay visible above the pads
...
function Table3D(
  ...
  const SIDE_CUSHION_POCKET_REACH_REDUCTION = TABLE.THICK * 0.042; // trim the side cushions a touch more so the tips stay clear of the pocket perimeter
