...
const CUE_OBSTRUCTION_LIFT = BALL_R * 0.18;
...
const AI_CAMERA_DROP_LEAD_MS = 560; // start lowering into cue view shortly before the AI pulls the trigger
