...
const POCKET_JAW_EDGE_TAPER_SCALE = 0.12; // keep the centre mass intact while letting the outer edge slim more toward each pocket shoulder
...
const POCKET_JAW_EDGE_TAPER_PROFILE_POWER = 2.2; // ease the taper more gradually so the edge slims gently toward each side pocket
