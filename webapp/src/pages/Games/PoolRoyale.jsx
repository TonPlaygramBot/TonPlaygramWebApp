...
const CHROME_CORNER_EXPANSION_SCALE = 1.02; // mirror the snooker plate reach so long-rail chrome hugs the rail edge identically
const CHROME_CORNER_SIDE_EXPANSION_SCALE = 1; // keep the short-rail chrome aligned exactly with the snooker trim footprint
...
const CHROME_CORNER_FIELD_FILLET_SCALE = 0; // match the crisp snooker chrome interior without the extra arcade fillet
const CHROME_CORNER_FIELD_EXTENSION_SCALE = 0; // use the snooker plate footprint with no extra field extension
const CHROME_CORNER_NOTCH_EXPANSION_SCALE = 1.015; // adopt the snooker notch scale so chrome arches match perfectly
const CHROME_CORNER_WIDTH_SCALE = 0.99; // keep corner chrome nearly full width like the snooker build
const CHROME_CORNER_HEIGHT_SCALE = 0.99; // keep corner chrome nearly full height like the snooker build
...
const CHROME_SIDE_NOTCH_THROAT_SCALE = 0.82; // reuse the snooker throat depth so arches mirror the reference table
const CHROME_SIDE_NOTCH_HEIGHT_SCALE = 0.85; // reuse the snooker throat height so the chrome window is identical
const CHROME_SIDE_NOTCH_RADIUS_SCALE = 0.6; // reuse the snooker throat radius proportion for matching arches
const CHROME_SIDE_NOTCH_DEPTH_SCALE = 1;
const CHROME_SIDE_FIELD_PULL_SCALE = 0;
const CHROME_SIDE_PLATE_POCKET_SPAN_SCALE = 1;
const CHROME_SIDE_PLATE_HEIGHT_SCALE = 1; // align side chrome height with the snooker layout
const CHROME_SIDE_PLATE_CENTER_TRIM_SCALE = 0; // drop the arcade trim so the side chrome mirrors snooker plates
const CHROME_SIDE_PLATE_WIDTH_EXPANSION_SCALE = 0;
const CHROME_SIDE_PLATE_CORNER_LIMIT_SCALE = 0.06; // adopt the snooker corner radius clamp
...
const WOOD_RAIL_POCKET_RELIEF_SCALE = 1; // let the wood rails share the exact snooker pocket arches
const WOOD_CORNER_RAIL_POCKET_RELIEF_SCALE = 1; // corner wood arches now reuse the snooker chrome radius verbatim
...
const POCKET_CORNER_MOUTH_SCALE = 1;
const POCKET_SIDE_MOUTH_SCALE = 1;
