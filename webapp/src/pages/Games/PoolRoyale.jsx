...
const CUSHION_HEIGHT_DROP = TABLE.THICK * 0.22; // drop the cushion tops further so their silhouette stays the same but sits lower
...
function Table3D(
  ...
  const cushionBaseY =
    CLOTH_TOP_LOCAL - MICRO_EPS + CUSHION_EXTRA_LIFT + CUSHION_BOTTOM_TRIM;
