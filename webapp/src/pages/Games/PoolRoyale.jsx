...
const WOOD_SIDE_POCKET_CUT_CENTER_OUTSET_SCALE = -0.014; // push the wooden middle-pocket relief further outward so the rounded cut sits noticeably farther from table centre
...
const SIDE_POCKET_JAW_LATERAL_EXPANSION =
  CORNER_POCKET_JAW_LATERAL_EXPANSION * 1.04; // push the middle jaw shoulders outward so they finish closer to the side rail relief
