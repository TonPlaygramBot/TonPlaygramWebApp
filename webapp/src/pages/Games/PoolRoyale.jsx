...
const CHROME_SIDE_PLATE_THICKNESS_BOOST = 1.32; // thicken the middle fascia so its depth now matches the corner plates
...
const CHROME_SIDE_PLATE_HEIGHT_SCALE = 2.375; // align fascia reach with snooker so the arch covers the relieved cut without overhang
const CHROME_SIDE_PLATE_CENTER_TRIM_SCALE = 0; // keep the middle fascia centred on the pocket without carving extra relief
const CHROME_SIDE_PLATE_WIDTH_EXPANSION_SCALE = 1.5125; // stretch fascia span farther along the side rails without pushing toward the field
...
const CHROME_SIDE_POCKET_CUT_CENTER_PULL_SCALE = 0.11; // pull the middle chrome arch farther toward centre so the rounded fascia cut tracks the shifted pocket
...
const SIDE_POCKET_JAW_VERTICAL_TWEAK = TABLE.THICK * 0.012; // lower the middle jaws slightly less so the fascia trims down from the top
const SIDE_POCKET_JAW_OUTWARD_SHIFT = TABLE.THICK * 0.246; // pull the middle pocket jaws closer to table centre so the lips sit farther from the side rails
...
const SIDE_POCKET_OUTWARD_BIAS = BALL_R * 0.18; // pull middle pocket centres even closer to the cloth field so the jaws follow the inward shift
