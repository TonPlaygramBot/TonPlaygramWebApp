...
const CHROME_SIDE_PLATE_HEIGHT_SCALE = 1.12; // pull the middle fascia back so it clears the field edge by the side pockets
...
const CHROME_SIDE_PLATE_OUTWARD_SHIFT_SCALE = 0.094; // push the side fascias deeper toward the wooden rail so no chrome creeps onto the cloth
...
const CHROME_SIDE_POCKET_CUT_CENTER_PULL_SCALE = -0.072; // carve the middle chrome cut farther outward so the fascia lifts off the playfield near the pocket lips
