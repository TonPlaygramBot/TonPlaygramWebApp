...
const POCKET_JAW_SIDE_EDGE_FACTOR = 0.36; // match the slimmer corner jaw shoulders for consistent liner taper
const POCKET_JAW_CORNER_MIDDLE_FACTOR = 0.92; // keep the centre mass similar to the snooker reference
const POCKET_JAW_SIDE_MIDDLE_FACTOR = 0.92; // align the side pocket midpoint thickness with the corner pocket specification
...
const SIDE_POCKET_EXTRA_SHIFT = BALL_R * 0.34; // push middle pockets farther outward so the chrome, rails, and jaws track the widened side span while keeping the chrome plates fixed
