...
const POCKET_JAW_CORNER_INNER_SCALE = 1.384; // pull the inner lip back slightly further so the pocket opening looks leaner while preserving the chrome-facing radius
const POCKET_JAW_SIDE_INNER_SCALE = 1.414; // mirror the tightened interior profile on the middle pockets while keeping the outer curve intact
