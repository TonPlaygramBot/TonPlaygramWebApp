...
const SIDE_POCKET_EXTRA_SHIFT = BALL_R * 1.88; // pull the middle pockets a little further toward centre so the jaw shoulders and chrome cuts sit tighter to the rails
