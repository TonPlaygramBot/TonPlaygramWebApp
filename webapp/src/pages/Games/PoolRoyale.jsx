...
const CHROME_CORNER_FIELD_TRIM_SCALE = 0.545; // shave extra chrome from the cloth-facing edge to keep the pocket clean
...
const CHROME_CORNER_WIDTH_SCALE = 0.958;
const CHROME_CORNER_HEIGHT_SCALE = 0.973;
