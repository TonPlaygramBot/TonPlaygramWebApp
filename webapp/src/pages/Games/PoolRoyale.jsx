...
const CUSHION_EXTRA_LIFT = -TABLE.THICK * 0.132; // sink the cushion base further so the pads settle slightly below the rail line
const CUSHION_HEIGHT_DROP = TABLE.THICK * 0.144; // trim the cushion tops more so chalks and diamonds stay visible above the pads
