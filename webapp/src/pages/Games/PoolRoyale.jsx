...
const CHROME_SIDE_PLATE_POCKET_SPAN_SCALE = 1.34; // push the side fascia deeper along the arch so it wraps the full chrome reveal
const CHROME_SIDE_PLATE_HEIGHT_SCALE = 1.3; // extend the middle fascia farther along the pocket arch so it blankets the rail relief
const CHROME_SIDE_PLATE_CENTER_TRIM_SCALE = 0; // keep the middle fascia centred on the pocket without carving extra relief
const CHROME_SIDE_PLATE_WIDTH_EXPANSION_SCALE = 0.19; // widen the middle fascia farther so it blankets the entire arch reveal
...
const SIDE_POCKET_JAW_DEPTH_EXPANSION = 0.96; // trim the middle jaws slightly so their height sits just shy of the corner profile
