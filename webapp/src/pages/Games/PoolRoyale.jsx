...
function Table3D(
  ...
  const SIDE_CUSHION_POCKET_REACH_REDUCTION = TABLE.THICK * 0.08; // trim middle cushion tips further so they end before the rounded rail cut, mirroring corner spacing without spilling into the jaws
  const SIDE_CUSHION_RAIL_REACH = TABLE.THICK * 0.034; // press the side cushions firmly into the rails without creating overlap
  const SIDE_CUSHION_CORNER_SHIFT = BALL_R * 0.12; // pull the side cushions slightly away from the middle pockets so the tips clear the pocket mouths
