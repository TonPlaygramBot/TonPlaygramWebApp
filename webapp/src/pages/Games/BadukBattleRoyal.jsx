...
const createBattleRoyalPieceMaterial = (color) =>
...
export default function BadukBattleRoyal() {
  ...
  const createTokenMesh = (token) => {
    ...
    const pieceMaterial = createBattleRoyalPieceMaterial(
      token === 'player' ? CONNECT4_RED : CONNECT4_BLUE
    );
    ...
    topCap.position.y = slotRadius * 0.106;
    topCap.castShadow = true;
    topCap.receiveShadow = true;
    pieceGroup.add(topCap);

    const rim = new THREE.Mesh(
      new THREE.TorusGeometry(slotRadius * 0.242, slotRadius * 0.019, 16, 64),
    ...
    rim.position.y = slotRadius * 0.118;
    pieceGroup.add(rim);
