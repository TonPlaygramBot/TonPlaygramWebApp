  ...
  const renderPreview = (key, option) => {
    switch (key) {
      ...
      case 'diceTheme': {
        ...
        return (
          <div className="w-full h-12 flex items-center justify-center">
            <div
              className="relative w-9 h-9 rounded-xl shadow-[0_6px_16px_rgba(15,23,42,0.55)]"
              style={{ background: body, boxShadow: `0 6px 16px ${rim}44` }}
            >
              <span
                className="absolute left-1.5 top-1.5 block h-2 w-2 rounded-full"
                style={{ background: pip, boxShadow: `0 0 0 2px ${rim}` }}
              />
              <span
                className="absolute right-1.5 bottom-1.5 block h-2 w-2 rounded-full"
                style={{ background: pip, boxShadow: `0 0 0 2px ${rim}` }}
              />
            </div>
          </div>
      ...
      case 'railTheme': {
        ...
        return (
          <div className="w-full h-12 rounded-xl border border-white/10 flex flex-col justify-center gap-1.5 px-2">
            <div
      ...
      case 'tables': {
        ...
        return (
          <div className="relative w-full h-14 overflow-hidden rounded-xl border border-white/10 bg-slate-800/50">
            ...
            <div className="absolute bottom-1.5 right-1.5 rounded-full bg-black/60 px-2 py-0.5 text-[0.55rem] font-semibold text-white/80">
              Poly Haven
            </div>
          </div>
        );
      ...
      case 'environmentHdri': {
        ...
        return (
          ...
          >
            <div className="flex h-full items-center justify-center gap-2 text-[0.55rem] font-semibold text-white/80">
                      ...
                      {options.map((option, idx) => {
                        ...
                        return (
                          <button
                            ...
                            className={`flex flex-col items-center gap-1.5 rounded-2xl border px-2 py-2 text-left transition focus:outline-none focus-visible:ring-2 focus-visible:ring-sky-300 ${
                              selected
