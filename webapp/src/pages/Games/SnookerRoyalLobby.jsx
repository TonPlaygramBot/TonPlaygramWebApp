...
const PLAYER_FLAG_STORAGE_KEY = 'snookerRoyalePlayerFlag';
const AI_FLAG_STORAGE_KEY = 'snookerRoyaleAiFlag';
...
export default function SnookerRoyalLobby() {
  ...
  const [variant] = useState('snooker');
    ...
    <div className="relative p-4 space-y-4 text-text min-h-screen tetris-grid-bg">
      ...
      <div className="space-y-2">
        ...
        <div className="flex gap-2">
          <button
            type="button"
            className="lobby-tile lobby-selected cursor-default"
            aria-pressed="true"
          >
            Snooker
          </button>
