...
const CHROME_SIDE_POCKET_CUT_CENTER_PULL_SCALE = 0.012; // pull the chrome arches closer to centre so the middle pocket jaws tuck in
...
const WOOD_SIDE_POCKET_CUT_CENTER_OUTSET_SCALE = 0.054; // pull the middle pocket wood cuts further inward toward centre
