...
const CORNER_POCKET_INWARD_SCALE = 1.015; // mirror Pool Royale corner relief depth for rail + chrome cuts
...
const CHROME_SIDE_POCKET_RADIUS_SCALE =
  CORNER_POCKET_INWARD_SCALE * CHROME_CORNER_POCKET_RADIUS_SCALE * 1.006; // reuse Pool Royale side pocket arch width
...
const CHROME_CORNER_POCKET_CUT_SCALE = 1.02;
const CHROME_SIDE_POCKET_CUT_SCALE = 1.012;
const WOOD_RAIL_POCKET_RELIEF_SCALE = 0.9;
const WOOD_CORNER_RELIEF_INWARD_SCALE = 0.984;
const WOOD_CORNER_RAIL_POCKET_RELIEF_SCALE =
  (1 / WOOD_RAIL_POCKET_RELIEF_SCALE) * WOOD_CORNER_RELIEF_INWARD_SCALE;
const WOOD_SIDE_RAIL_POCKET_RELIEF_SCALE = 0.956;
const WOOD_CORNER_CUT_SCALE = WOOD_CORNER_RAIL_POCKET_RELIEF_SCALE;
const WOOD_SIDE_CUT_SCALE = WOOD_SIDE_RAIL_POCKET_RELIEF_SCALE;
const POCKET_JAW_CORNER_OUTER_LIMIT_SCALE = 1.004;
const POCKET_JAW_SIDE_OUTER_LIMIT_SCALE =
  POCKET_JAW_CORNER_OUTER_LIMIT_SCALE * 0.986;
...
const POCKET_JAW_SIDE_OUTER_SCALE = POCKET_JAW_CORNER_OUTER_SCALE * 0.944;
...
const SIDE_POCKET_JAW_LATERAL_EXPANSION = CORNER_POCKET_JAW_LATERAL_EXPANSION * 0.94;
const SIDE_POCKET_JAW_RADIUS_EXPANSION = 0.97;
const SIDE_POCKET_JAW_DEPTH_EXPANSION = 0.974;
 ...
 */
const CAMERA_FRAMING_SCALE = 0.7; // pull cameras 30% closer so the table reads larger without rescaling geometry
const SHORT_RAIL_CAMERA_DISTANCE =
  (PLAY_H / 2 + BALL_R * 12) * CAMERA_FRAMING_SCALE; // pull broadcast cams closer so the snooker table fills the frame
