...
const AI_CHAIR_GAP = CARD_W * 0.92;
...
const CAMERA_RETREAT_OFFSETS = Object.freeze({ portrait: 0.96, landscape: 1.18 });
const CAMERA_ELEVATION_OFFSETS = Object.freeze({ portrait: 1.44, landscape: 0.7 });
const CAMERA_LANDSCAPE_LOOK_UP_LIFT = CARD_H * 0.42;
const CAMERA_PORTRAIT_LOOK_UP_LIFT = CARD_H * 0.36;
const CAMERA_LANDSCAPE_LOOK_RIGHT_SHIFT = 0;
const CAMERA_PORTRAIT_MIN_LOOK_UP = THREE.MathUtils.degToRad(40);
const CAMERA_PORTRAIT_MAX_LOOK_DOWN = THREE.MathUtils.degToRad(38);
const CAMERA_LANDSCAPE_MIN_LOOK_UP = THREE.MathUtils.degToRad(36);
const CAMERA_LANDSCAPE_MAX_LOOK_DOWN = THREE.MathUtils.degToRad(38);
const HUMAN_SEAT_INWARD_OFFSETS = Object.freeze({ portrait: CARD_W * -0.58, landscape: -CARD_W * 0.86 });
...
const TEXAS_MURLAN_CHARACTER_EXTRA_OUTWARD_OFFSET = 0.66;
const TEXAS_MURLAN_CHARACTER_EXTRA_LOWER_OFFSET = 0.28;
const TEXAS_CHARACTER_TABLE_INWARD_OFFSET = 1.26;
const TEXAS_HUMAN_CHARACTER_TABLE_INWARD_OFFSET = 1.04;
