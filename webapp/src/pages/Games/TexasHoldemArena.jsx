...
const CAMERA_LATERAL_OFFSETS = Object.freeze({ portrait: -0.03, landscape: 0.2 });
const CAMERA_RETREAT_OFFSETS = Object.freeze({ portrait: 0.3, landscape: 0.36 });
const CAMERA_ELEVATION_OFFSETS = Object.freeze({ portrait: 1.34, landscape: 1.2 });
const HUMAN_SEAT_INWARD_OFFSETS = Object.freeze({ portrait: CARD_W * 0.95, landscape: -CARD_W * 0.28 });
