...
const TEXAS_SIZE_SCALE = 0.92;
const TABLE_RADIUS = 3.4 * MODEL_SCALE * TEXAS_SIZE_SCALE;
const BASE_TABLE_HEIGHT = 1.08 * MODEL_SCALE * TEXAS_SIZE_SCALE;
const ARENA_SCALE = 1.3 * ARENA_GROWTH;
const BOARD_SIZE = (TABLE_RADIUS * 2 + 1.2 * MODEL_SCALE * TEXAS_SIZE_SCALE) * ARENA_SCALE;
const CHAIR_SIZE_SCALE = 1 * TEXAS_SIZE_SCALE;
const STOOL_SCALE = 1.5 * 1.3 * CHAIR_SIZE_SCALE;
const CARD_SCALE = 0.95 * TEXAS_SIZE_SCALE;
...
const BASE_HUMAN_CHAIR_RADIUS = 5.6 * MODEL_SCALE * ARENA_GROWTH * 0.85 * TEXAS_SIZE_SCALE;
const HUMAN_CHAIR_PULLBACK = 0.32 * MODEL_SCALE * TEXAS_SIZE_SCALE;
...
const HUMAN_CARD_SCALE = TEXAS_SIZE_SCALE;
const COMMUNITY_CARD_SCALE = 1.08 * TEXAS_SIZE_SCALE;
const HUMAN_CHIP_SCALE = TEXAS_SIZE_SCALE;
...
const RAIL_CHIP_SCALE = 1.08 * TEXAS_SIZE_SCALE;
