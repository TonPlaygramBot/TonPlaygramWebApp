...
const HUMAN_CHAIR_PULLBACK = -0.38 * MODEL_SCALE;
...
const CAMERA_RETREAT_OFFSETS = Object.freeze({ portrait: 0.68, landscape: -0.3 });
...
const HUMAN_SEAT_INWARD_OFFSETS = Object.freeze({ portrait: CARD_W * 0.2, landscape: -CARD_W * 0.52 });
