...
const CAMERA_RETREAT_OFFSETS = Object.freeze({ portrait: 0.132, landscape: -0.3 });
...
const HUMAN_SEAT_INWARD_OFFSETS = Object.freeze({ portrait: CARD_W * -0.72, landscape: -CARD_W * 0.52 });
