...
const FRAME_RATE_TO_HDRI_RESOLUTION_MAP = Object.freeze({
  fhd60: Object.freeze({ primary: '2k', fallback: [] }),
  qhd90: Object.freeze({ primary: '4k', fallback: [] }),
  uhd120: Object.freeze({ primary: '8k', fallback: [] })
});
            ...
            <div className="rounded-xl border border-white/10 bg-white/5 p-3 space-y-2">
              <div>
                ...
                <p className="mt-1 text-[0.7rem] text-white/60">
                  Graphics preset controls HDRI automatically: 60 Hz → 2K, 90 Hz → 4K, 120 Hz → 8K.
                </p>
              </div>
