...
const CAMERA_RETREAT_OFFSETS = Object.freeze({ portrait: 0.92, landscape: -0.3 });
...
const HUMAN_SEAT_INWARD_OFFSETS = Object.freeze({ portrait: CARD_W * -0.32, landscape: -CARD_W * 0.52 });
