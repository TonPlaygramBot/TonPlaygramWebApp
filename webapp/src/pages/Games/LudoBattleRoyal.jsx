...
const TABLE_VERTICAL_DROP = 0.42 * MODEL_SCALE;
...
const CAMERA_EXTRA_LIFT = 0.5 * MODEL_SCALE;
const PORTRAIT_CAMERA_EXTRA_LIFT = 0.62 * MODEL_SCALE;
const CAMERA_SEATED_INWARD_OFFSET = 0.42 * MODEL_SCALE;
const CAMERA_SEATED_EYE_HEIGHT = 0.86 * MODEL_SCALE;
const PORTRAIT_CAMERA_SEATED_EYE_HEIGHT = 0.98 * MODEL_SCALE;
