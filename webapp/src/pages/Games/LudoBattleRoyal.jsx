...
const TABLE_SIDE_EXPANSION_FACTOR = 1.16;
...
const CHAIR_OUTWARD_OFFSET = 0.24 * MODEL_SCALE;
const CHAIR_INWARD_PULL = 0.27 * MODEL_SCALE;
...
const PAWN_TOKEN_SCALE = Object.freeze({ x: ROCK_TOKEN_REFERENCE_SCALE.x, y: 0.89, z: ROCK_TOKEN_REFERENCE_SCALE.z });
