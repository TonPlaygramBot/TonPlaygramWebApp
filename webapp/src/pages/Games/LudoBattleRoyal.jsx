...
const PLAYER_VIEW_CAMERA_BACK_OFFSET_PORTRAIT = 1.08;
const PLAYER_VIEW_CAMERA_BACK_OFFSET_LANDSCAPE = 1.26;
const PLAYER_VIEW_CAMERA_FORWARD_OFFSET_PORTRAIT = 2.28;
...
const PLAYER_VIEW_FIRST_PERSON_EYE_FORWARD_PORTRAIT = 0.5 * MODEL_SCALE;
