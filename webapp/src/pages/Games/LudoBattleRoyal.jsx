...
// ~15% smaller in world space while preserving the same relative layout.
const LUDO_ARENA_SHRINK_FACTOR = 0.85;
...
const CAMERA_ZOOM_MIN_FACTOR = 0.68;
const CAMERA_ZOOM_MAX_FACTOR = 1.55;
...
const LANDSCAPE_CAMERA_TUNING = Object.freeze({
  ...
  forwardOffset: 0.82 * ARENA_SCALE_RATIO * LUDO_ARENA_SHRINK_FACTOR,
  heightOffset: 0.54 * ARENA_SCALE_RATIO * LUDO_ARENA_SHRINK_FACTOR
});
const PORTRAIT_CAMERA_TUNING = Object.freeze({
  backOffset: 0.33 * ARENA_SCALE_RATIO * LUDO_ARENA_SHRINK_FACTOR,
  forwardOffset: 1.0 * ARENA_SCALE_RATIO * LUDO_ARENA_SHRINK_FACTOR,
  heightOffset: 0.5 * ARENA_SCALE_RATIO * LUDO_ARENA_SHRINK_FACTOR,
