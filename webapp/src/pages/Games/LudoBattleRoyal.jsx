...
const ARENA_LAYOUT_TRIM_FACTOR = 0.94;
const ARENA_SCALE = 0.72 * LUDO_ARENA_SHRINK_FACTOR * ARENA_LAYOUT_TRIM_FACTOR;
...
const LANDSCAPE_CAMERA_TUNING = Object.freeze({
  backOffset: 0.78 * ARENA_SCALE_RATIO * LUDO_ARENA_SHRINK_FACTOR,
  forwardOffset: 0.9 * ARENA_SCALE_RATIO * LUDO_ARENA_SHRINK_FACTOR,
  heightOffset: 0.82 * ARENA_SCALE_RATIO * LUDO_ARENA_SHRINK_FACTOR
});
...
const CAMERA_3D_HEIGHT_BOOST = 0.04 * MODEL_SCALE;
