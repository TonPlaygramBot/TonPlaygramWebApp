...
// May 8 tabletop parking: anchor selected firearms beside each player king token
// using the original table-side offsets, not the newer dice-rail fallback slots.
...
const PLAYER_VIEW_CAMERA_FORWARD_OFFSET_PORTRAIT = 2.37;
const PLAYER_VIEW_CAMERA_FORWARD_OFFSET_LANDSCAPE = 1.0;
const PLAYER_VIEW_CAMERA_HEIGHT_OFFSET_PORTRAIT = 1.36;
const PLAYER_VIEW_CAMERA_HEIGHT_OFFSET_LANDSCAPE = 0.94;
...
const CAMERA_LOOKDOWN_TARGET_OFFSET = 0.082 * MODEL_SCALE;
