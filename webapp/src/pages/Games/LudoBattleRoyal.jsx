...
function createCaptureDroneFx() {
  ...
  addFxCylinder(root, 0.13, 0.18, 2.85, [0, 0, 0], [0, 0, Math.PI / 2], '#c3cbd1', 24);
  const nose = new THREE.Mesh(
    new THREE.ConeGeometry(0.17, 0.68, 22),
    new THREE.MeshStandardMaterial({ color: '#d8dce0', roughness: 0.48, metalness: 0.2 })
  );
  nose.position.set(1.74, 0, 0);
  nose.rotation.z = -Math.PI / 2;
  nose.castShadow = true;
  root.add(nose);
  addFxCylinder(root, 0.17, 0.13, 0.58, [-1.62, 0, 0], [0, 0, Math.PI / 2], '#778188', 16);
...
function createCaptureJetFx() {
  const root = new THREE.Group();
  addFxCylinder(root, 0.15, 0.21, 3.18, [0, 0, 0], [0, 0, Math.PI / 2], '#bcc3c9', 28);
  const nose = new THREE.Mesh(
    new THREE.ConeGeometry(0.16, 1.02, 24),
    new THREE.MeshStandardMaterial({ color: '#d9dde2', roughness: 0.42, metalness: 0.2 })
  );
  ...
  const wing = createFxPolygon([[-1.6, -2.25], [0.8, 0], [-0.4, 2.25]], 0.1, '#9ba4ac', 0.66, 0.18);
...
function createCaptureHelicopterFx() {
  const root = new THREE.Group();
  addFxCylinder(root, 0.18, 0.22, 2.56, [0, 0, 0], [0, 0, Math.PI / 2], '#86909a', 24, 0.56, 0.26);
  const nose = new THREE.Mesh(
    new THREE.ConeGeometry(0.2, 0.88, 22),
    new THREE.MeshStandardMaterial({ color: '#99a3ad', roughness: 0.5, metalness: 0.2 })
  );
