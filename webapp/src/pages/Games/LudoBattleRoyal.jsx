      ...
      void (async () => {
        ...
        if (isFirearmAttack) {
          ...
          const bullets = Array.from({ length: projectileCount }, (_, index) => {
            ...
            mesh.userData.prelaunchMs = useServicePistolAmmo ? FIREARM_SERVICE_PISTOL_PRELAUNCH_MS : 0;
            mesh.userData.insideBarrelOffset = useServicePistolAmmo ? FIREARM_SERVICE_PISTOL_INSIDE_BARREL_OFFSET : 0;
