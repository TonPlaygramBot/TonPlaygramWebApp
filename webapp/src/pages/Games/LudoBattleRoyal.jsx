...
// Keep portrait framing locked so players cannot lift the camera upward.
const LUDO_CAMERA_PHI_MAX = LUDO_CAMERA_PHI_MIN;
...
// Pull the default 3D view slightly closer to the table.
const INITIAL_CAMERA_DISTANCE_FACTOR = 0.76;
