...
export default function BrickBreakerLobby() {
  ...
  const startGame = async () => {
    ...
    navigate(`/games/brickbreaker?${params.toString()}`);
  };

  return (
    <div className="relative p-4 space-y-4 text-text min-h-screen game-lobby brickbreaker-lobby-bg">
