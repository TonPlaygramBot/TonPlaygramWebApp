...
export default function BowlingGame() {
  const BUILD_TAG = "BOWLING_MECHANISM_V3";
  ...
  return <div style={{position:"fixed",inset:0,overflow:"hidden",background:"#07090d",touchAction:"none",userSelect:"none"}}>
    ...
    <div style={{position:"fixed",inset:0,pointerEvents:"none",fontFamily:"system-ui,-apple-system,sans-serif",color:"white"}}>
      ...
      <div style={{position:"absolute",left:62,right:12,top:24,padding:"8px 10px",borderRadius:12,background:"rgba(6,8,11,.88)",border:"1px solid rgba(116,240,255,.55)"}}>
        ...
        <div style={{marginTop:4,fontSize:11,opacity:.95,color:"#74f0ff",fontWeight:800}}>Pinsetter + Ball Return v2 active • {BUILD_TAG}</div>
      </div>
      <div style={{position:"absolute",left:12,right:12,bottom:14,padding:"8px 10px",borderRadius:10,textAlign:"center",fontSize:12,fontWeight:800,color:"#ffe28a",background:"rgba(8,12,18,.74)",border:"1px solid rgba(255,226,138,.55)"}}>NEW BOWLING BUILD ACTIVE: {BUILD_TAG}</div>
