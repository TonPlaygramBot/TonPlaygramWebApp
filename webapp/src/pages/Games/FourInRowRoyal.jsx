...
const TABLE_SCALE = TABLE_BASE_SCALE * TABLE_SIZE_REDUCTION_FACTOR;
const CHAIR_SCALE = TABLE_BASE_SCALE * CHAIR_SIZE_BOOST_FACTOR;
...
const TABLE_HEIGHT = 1.2 * ROW_GAME_SCALE_REDUCTION * TABLE_SIZE_REDUCTION_FACTOR;
...
export default function FourInRowRoyal() {
  ...
  useEffect(() => {
    ...
    const cameraHeightOffset =
      (isPortrait ? 1.12 : 0.94) * CAMERA_FRAME_MATCH_SCALE;
    const cameraRadius =
