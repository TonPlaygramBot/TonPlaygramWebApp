...
const CHROME_SIDE_PLATE_OUTER_EXTENSION_SCALE = 0.86; // trim the middle fascia's outer reach so excess chrome is shaved back while keeping the rounded cut untouched
...
const CHROME_SIDE_PLATE_OUTWARD_SHIFT_SCALE = 0.14; // push the side fascias outward so the chrome plate sits further outside the middle pockets without moving the rounded cut
