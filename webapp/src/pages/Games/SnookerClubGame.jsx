...
const CUSHION_EXTRA_LIFT = -TABLE.THICK * 0.062; // sink the cushion base only slightly so the pads rest closer to the rail line
const CUSHION_HEIGHT_DROP = TABLE.THICK * 0.158; // trim the cushion tops further so the surface sits flush with the wooden rails
