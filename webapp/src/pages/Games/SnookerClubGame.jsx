 ...
 */
const SHORT_RAIL_CAMERA_DISTANCE = PLAY_H / 2 + BALL_R * 16; // pull the rail overhead broadcast cams slightly farther out while keeping at least half the field visible
