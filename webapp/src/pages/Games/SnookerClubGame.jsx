...
const CUSHION_EXTRA_LIFT = -TABLE.THICK * 0.06; // align the cushion base lift with Pool Royale so the tops sit level together
const CUSHION_HEIGHT_DROP = TABLE.THICK * 0.18; // match Pool Royale's cushion trim so rail and cushion heights stay consistent
