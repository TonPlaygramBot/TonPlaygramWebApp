...
const CUSHION_EXTRA_LIFT = -TABLE.THICK * 0.06; // match the Pool Royale rail line so the cushion bases settle flush without gaps
const CUSHION_HEIGHT_DROP = TABLE.THICK * 0.18; // align the cushion trim to the Pool Royale profile so the tops sit level with the wooden rails
