...
const CUSHION_EXTRA_LIFT = -TABLE.THICK * 0.142; // sink the cushion base further so the pads settle slightly below the rail line
const CUSHION_HEIGHT_DROP = TABLE.THICK * 0.15; // trim the cushion tops more so chalks and diamonds stay visible above the pads
...
const CUSHION_FACE_INSET = SIDE_RAIL_INNER_THICKNESS * 0.195; // push the playable face and cushion nose further inward to match the expanded top surface
