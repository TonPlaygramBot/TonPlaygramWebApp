...
const CUSHION_EXTRA_LIFT = -TABLE.THICK * 0.055; // raise the cushion base so its height aligns with Pool Royale's flush profile
const CUSHION_HEIGHT_DROP = TABLE.THICK * 0.24; // trim the cushion tops further so they no longer ride above the rails
