...
const LEG_FOOT_RADIUS_SCALE = 1.36; // widen the chrome puck so each leg sits on a visible base like the reference photo
const LEG_FOOT_HEIGHT_SCALE = 0.32; // slim chrome foot height so the stance stays unchanged while the pad remains visible
