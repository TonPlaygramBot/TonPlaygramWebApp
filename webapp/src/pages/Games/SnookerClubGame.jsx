...
const CHROME_CORNER_POCKET_CUT_SCALE = 1.045; // open the rounded chrome corner cut slightly more while tucking it inward
const CHROME_SIDE_POCKET_CUT_SCALE = 1.08; // widen and deepen the middle chrome arch so the rounded cut opens up while sitting further inboard
...
const CUSHION_EXTRA_LIFT = 0; // seat cushions directly against the wood so there is no gap under the rail line
const CUSHION_HEIGHT_DROP = TABLE.THICK * 0.12; // keep cushion tops level with the rails while retaining a trimmed profile
...
const SHOT_POWER_BOOST = 1.625; // lift Snooker Club strike strength a further 30%
...
const TABLE_HEIGHT_REDUCTION = 0.9; // raise the table slightly so the playfield sits taller
