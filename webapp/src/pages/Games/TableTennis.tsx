...
export default function MobileRealisticTableTennisGame() {
  ...
  useEffect(() => {
    ...
    const nearPlayer = addHuman(scene, renderer, "near", new THREE.Vector3(0, 0, TABLE_HALF_L + 0.72), 0xff6b2e, humanModelUrl);
    const farPlayer = addHuman(scene, renderer, "far", new THREE.Vector3(0, 0, -TABLE_HALF_L - 0.72), 0x4ab7ff, humanModelUrl);
    ...
    const resize = () => {
      ...
      camera.position.set(0, camera.aspect < 0.72 ? 3.95 : 3.35, camera.aspect < 0.72 ? 4.75 : 4.1);
