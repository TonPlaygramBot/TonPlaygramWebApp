...
export default function SlingshotRoyaleLobby() {
  ...
  const startGame = async () => {
    ...
    navigate(`/games/slingshotroyale?${params.toString()}`);
  };

  return (
    <div className="relative p-4 space-y-4 text-text">
      <h2 className="text-xl font-bold text-center">Slingshot Royale Lobby</h2>
