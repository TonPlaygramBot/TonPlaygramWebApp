...
export default function MurlarnRoyaleLobby() {
  ...
  const startGame = async () => {
    ...
    navigate(`/games/murlarnroyale?${params.toString()}`);
  };

  return (
    <div className="relative p-4 space-y-4 text-text min-h-screen tetris-grid-bg">
      <h2 className="text-xl font-bold text-center">Murlarn Royale Lobby</h2>
