...
const TABLE_SIZE_SHRINK = 1.08; // expand the cloth footprint back toward full snooker coverage while keeping proportions intact
const TABLE_REDUCTION = 1.02; // keep the larger snooker silhouette without trimming the rails down to the Pool Royale size
...
const TABLE_SCALE = TABLE_BASE_SCALE * TABLE_REDUCTION; // keep snooker proportions while enlarging the table for Snooker Club
const TABLE = {
  W: 66 * TABLE_SCALE,
  H: 132 * TABLE_SCALE,
