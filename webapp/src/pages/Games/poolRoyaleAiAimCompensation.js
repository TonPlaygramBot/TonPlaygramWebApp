...
export const resolveAiPotGhostAim = ({
  ...
  // The simulation launches the cue ball along aimDir; cue-tip spin affects its
  // behaviour at/after contact, not the pre-contact centre line. Adding an
  // empirical side or power offset here therefore makes otherwise correct pots
  // miss a jaw. Keep the contact normal exactly on the selected pocket lane.
