  ...
  return (
    <div className="p-4 space-y-2">
      ...
      <div className="space-x-2">
        <button className="px-2 py-1 bg-green-500 text-text" onClick={handleStart}>Start</button>
        <button className="px-2 py-1 bg-accent text-text" onClick={handleStop}>Stop</button>
