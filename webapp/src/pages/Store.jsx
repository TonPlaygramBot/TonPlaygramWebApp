...
export default function Store() {
  ...
  const ownedCheckers = useMemo(
    ...
    [poolOwned, chessOwned, murlanOwned]
  );
  ...
  const ownedItemLookup = useMemo(
    ...
    [poolOwnedOptions, chessOwnedOptions, murlanOwnedOptions]
  );
      ...
      {activeSlug === 'murlanroyale' && (
        <>
          <div className="store-card max-w-2xl">
            ...
            <p className="text-sm text-subtext">
              First-look table, cloth, base, card, stool, and outfit options stay unlocked. Purchase more to reveal them
              inside the table setup menu.
            </p>
            <ul className="mt-2 space-y-1 w-full">
