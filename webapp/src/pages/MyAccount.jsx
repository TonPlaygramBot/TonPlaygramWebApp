...
export default function MyAccount() {
      ...
      if (accountPayload?.error || !accountPayload?.accountId) {
        throw new Error(
          accountPayload?.error ||
            'Unable to load your TPG account. Please try again.'
        );
      }
  ...
  const handleLinkTelegram = async () => {
    ...
    try {
      ...
      setLinkFeedback('Telegram linked. We refreshed your TPG profile.');
  ...
  const devPanelTools = [
    {
      label: 'Top up',
      value: 'Instant TPG credit testing',
      icon: FiDollarSign
    },
    ...
    <div className="profile-page app-theme-page relative p-3 sm:p-4 space-y-4 text-text wide-card max-w-4xl mx-auto">
      ...
      <div className="grid grid-cols-1 xl:grid-cols-2 gap-4">
        ...
        {profile && profile.accountId === DEV_ACCOUNT_ID && (
          <div className="bg-surface border border-border rounded-xl p-4 space-y-4 xl:col-span-2">
            <div className="space-y-1">
