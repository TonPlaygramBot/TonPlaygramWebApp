              ...
              <table className="w-full text-xs text-center mt-2 border-collapse">
                <thead>
                  <tr className="border-b border-border">
                    ...
                    <th className="py-1 flex items-center justify-center gap-1">Reward <img src="/assets/icons/TPCcoin_1.webp" alt="TPC" className="w-4 h-4" /></th>
                ...
                <tbody>
                  {INFLUENCER_REWARDS.map((r) => (
                    <tr key={r.range} className="border-b border-border last:border-0">
                      ...
                      <td className="py-1 flex items-center justify-center gap-1">{r.reward.toLocaleString()} <img src="/assets/icons/TPCcoin_1.webp" alt="TPC" className="w-4 h-4" /></td>
              ...
              {myVideos.map((s) => (
                <li key={s._id} className="lobby-tile w-full space-y-1">
                  ...
                  <div className="flex justify-between text-xs">
                    ...
                    <span className="flex items-center gap-1">{s.rewardTPC.toLocaleString()} <img src="/assets/icons/TPCcoin_1.webp" alt="TPC" className="w-4 h-4" /></span>
                  </div>
                </li>
              ))}
              {myVideos.length === 0 && (
