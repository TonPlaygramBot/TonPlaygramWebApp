        ...
        <>
            <ul className="space-y-2">
              <li className="lobby-tile w-full">
                <div className="grid grid-cols-[20px_1fr_auto_auto] items-center gap-2 w-full">
                  ...
                  <span className="text-xs text-subtext flex items-center gap-1">{REWARDS[streak - 1]} <img src="/assets/icons/file_00000000362481f7978631c42572193f.png" alt="TPG" className="w-4 h-4" /></span>
          ...
          {tasks.map((t) => (
            <li key={t.id} className="lobby-tile w-full">
              <div className="grid grid-cols-[20px_1fr_auto_auto] items-center gap-2 w-full">
                ...
                <span className="text-xs text-subtext flex items-center gap-1">{t.reward} <img src="/assets/icons/file_00000000362481f7978631c42572193f.png" alt="TPG" className="w-4 h-4" /></span>
          ...
          <li className="lobby-tile w-full">
            <div className="grid grid-cols-[20px_1fr_auto_auto] items-center gap-2 w-full">
              ...
              <span className="text-xs text-subtext flex items-center gap-1">50 <img src="/assets/icons/file_00000000362481f7978631c42572193f.png" alt="TPG" className="w-4 h-4" /></span>
              {adCount >= 5 ? (
                <span className="text-green-500 font-semibold text-sm">Completed</span>
              ) : (
                <button
          ...
          <li className="lobby-tile w-full">
            <div className="grid grid-cols-[20px_1fr_auto_auto] items-center gap-2 w-full">
              ...
              <span className="text-xs text-subtext flex items-center gap-1">200 <img src="/assets/icons/file_00000000362481f7978631c42572193f.png" alt="TPG" className="w-4 h-4" /></span>
              {questTime > 0 ? (
              ...
              <table className="w-full text-xs text-center mt-2 border-collapse">
                <thead>
                  <tr className="border-b border-border">
                    ...
                    <th className="py-1 flex items-center justify-center gap-1">Reward <img src="/assets/icons/file_00000000362481f7978631c42572193f.png" alt="TPG" className="w-4 h-4" /></th>
                ...
                <tbody>
                  {INFLUENCER_REWARDS.map((r) => (
                    <tr key={r.range} className="border-b border-border last:border-0">
                      ...
                      <td className="py-1 flex items-center justify-center gap-1">{r.reward.toLocaleString()} <img src="/assets/icons/file_00000000362481f7978631c42572193f.png" alt="TPG" className="w-4 h-4" /></td>
              ...
              {myVideos.map((s) => (
                <li key={s._id} className="lobby-tile w-full space-y-1">
                  ...
                  <div className="flex justify-between text-xs">
                    ...
                    <span className="flex items-center gap-1">{s.rewardTPC.toLocaleString()} <img src="/assets/icons/file_00000000362481f7978631c42572193f.png" alt="TPG" className="w-4 h-4" /></span>
                  </div>
                </li>
              ))}
              {myVideos.length === 0 && (
