      ...
      <div className="flex flex-col items-center">
        ...
        <div className="w-full rounded-xl border border-border bg-surface/60 p-3 mb-2 space-y-2">
          ...
          <div className="flex gap-3">
            <Link to="/hub" className="inline-flex text-xs text-primary underline">Open TPC Account Hub</Link>
            <Link to="/exchange" className="inline-flex text-xs text-primary underline">Open Exchange</Link>
          </div>
        </div>
