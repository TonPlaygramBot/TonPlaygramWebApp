...
import { driverSocket, driverPoint, driverWheel } from '../shared/driverView.mjs';
...
export function takeVehicle(state, p, car) {
  ...
  car.vx = 0;
  car.vz = 0;
  car.yawRate = car.steering = car.steerAngle = 0;
  car.slip = 0;
  car.braking = car.handbraking = false;
  p.carId = car.id;
  p.x = car.x;
  p.z = car.z;
