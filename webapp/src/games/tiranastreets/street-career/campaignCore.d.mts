...
export type StreetProfile={version:1;completed:string[];best:Record<string,number>;records:Record<string,{grade:'gold'|'silver'|'bronze';runs:number;integrity:number}>;loadout:Loadout;active:null|{id:string;difficulty:string;checkpoint:Loadout;phase?:import('./checkpointCore.mjs').PhaseCheckpoint}};
