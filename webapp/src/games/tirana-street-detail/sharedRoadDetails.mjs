...
const existing=buildRoadDetails(WORLD,{signals:SIGNALS,river:RIVER_PATHS,exclude,includeCycling:false});
export const STREET_DETAILS={...existing,
  ...
  accuracy:'OSM cycling centrelines and side tags; missing widths and marking style are authored. Existing pedestrian posts retained.'};
