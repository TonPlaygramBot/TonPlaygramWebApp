...
export function buildRoadDetails(world:any,options?:{signals?:readonly any[];river?:readonly any[];exclude?:(x:number,z:number,radius:number)=>boolean}):RoadDetails;
