...
export function buildRoadDetails(world:any,options?:{signals?:readonly any[];river?:readonly any[];includeCycling?:boolean;includePosts?:boolean;exclude?:(x:number,z:number,radius:number)=>boolean}):RoadDetails;
