...
export const OBSERVED_HEIGHTS={'731114346':{height:10.8,basis:'Three levels visible in Studioarch4 exterior; 3.6 m per level estimated, not surveyed',source:'https://studioarch4.com/portfolio_page/servete-maci-school/'}};
