...
export function housingProfile(b){
 ...
 if((['house','detached','semidetached_house','terrace','villa'].includes(b.tags?.building)||(RURAL_HOUSE_IDS.has(String(b.id))&&b.tags?.building==='residential'&&b.h<=12))&&!b.tags?.construction){const modern=b.roofShape==='flat';return{kind:'house',modern,colourful:false,colour:modern?0xd6d3c8:0xd0bfa4,bay:RURAL_HOUSE_IDS.has(String(b.id))?'villa-bay':modern?'modern-house-bay':'house-bay',spacing:modern?3.6:3.5,windowHeight:modern?1.55:1.7};}
 return null;
}
