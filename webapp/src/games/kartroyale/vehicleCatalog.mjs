...
export const KARTS = [
  ...
  { id: 'photon', name: 'Photon GT', detail: 'Electric sprint · Responsive acceleration', speed: 1.10, handling: 1.02, brake: 1.02, shield: 0, ammunition: 0 },
  { id: 'vortex', name: 'Vortex R', detail: 'Electric sport · Built for drift', speed: 1.02, handling: 1.23, brake: 1.04, shield: 0, ammunition: 0 },
  { id: 'aegis', name: 'Aegis XR', detail: 'Electric endurance · Fast launch', speed: 1.04, handling: 1.08, brake: 1.18, shield: 0, ammunition: 0 }
];
