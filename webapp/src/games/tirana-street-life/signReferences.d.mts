export type SignReference={id:string;match:RegExp;logo:string;source:string;background:string;foreground:string;crop:[number,number,number,number]|null;keepName?:boolean};
