...
export type BotContext={allies?:(Vec2&{id:string})[];canReach?:(a:Vec2,b:Vec2)=>boolean;mode?:BattleMode;zoneRadius?:number;intelCollected?:boolean;intelPoint?:Vec2;extractionPoint?:Vec2;covers?:Vec2[];reports?:Pick<BotBrain,'lastSeen'|'seenAt'>[];noise?:(Vec2&{at:number})|null;loot?:(Vec2&{id:string;ammo:number})[]};
