...
export function Game(props:ComponentProps<typeof OperationGame>){
 const [activity,setActivity]=useState(()=>{const a=typeof window!=='undefined'?new URLSearchParams(window.location.search).get('activity'):'';return a==='street-career'?'street-career':a==='career'?'stories':'operation';});
