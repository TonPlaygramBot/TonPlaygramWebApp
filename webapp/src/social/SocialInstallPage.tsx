...
export default function SocialInstallPage() {
  ...
  return <main className="social-install-page">
    <div className="social-install-hero">
      ...
      <p>Your friends, your chats, your studio.<br />One app, with its own home screen icon.</p>
    ...
    <div className="social-install-features"><span>Your community</span><span>Chats & friends</span><span>Creator Studio</span></div>
    ...
    <section className="social-install-steps"><h2>Still your TonPlayGram</h2><p>Your profile, conversations, and connected Studio accounts use the same platform. In a different browser, sign in with your existing account.</p><a className="social-text-link" href="/account">Account settings <ArrowUpRight size={16} /></a></section>
  </main>;
}
