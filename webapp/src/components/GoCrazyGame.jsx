...
const WEAPON_MODELS = [
  { id: "FIREARM", urls: ["https://static.poly.pizza/3b53f0fe-f86e-451c-816d-6ab9bd265cdc.glb", "https://cdn.jsdelivr.net/gh/SAAAM-LLC/3D_model_bundle@main/SAM_ASSET-PISTOL-IN-HOLSTER.glb"] },
  { id: "RIFLE", urls: ["https://static.poly.pizza/b3e6be61-0299-4866-a227-58f5f3fe610b.glb", "https://cdn.jsdelivr.net/gh/GarbajYT/godot-sniper-rifle@master/AWP.glb"] },
  { id: "MISSILE", urls: ["https://cdn.jsdelivr.net/gh/srcejon/sdrangel-3d-models@main/atlas_v.glb", "https://cdn.jsdelivr.net/gh/microsoft/MixedRealityToolkit@main/SpatialInput/Samples/DemoRoom/Media/Models/Gun.glb"] },
  { id: "DRONE", urls: ["https://cdn.jsdelivr.net/gh/srcejon/sdrangel-3d-models@main/drone.glb"] },
  { id: "HELICOPTER", urls: ["https://cdn.jsdelivr.net/gh/srcejon/sdrangel-3d-models@main/helicopter.glb"] },
  { id: "JET", urls: ["https://cdn.jsdelivr.net/gh/srcejon/sdrangel-3d-models@main/f15.glb"] }
];
...
export default function SuperTuxKartPlayablePreview() {
  ...
  useEffect(() => {
    ...
    async function start() {
      ...
      const WEAPON_MODEL_BY_ID = Object.fromEntries(WEAPON_MODELS.map((item) => [item.id, item.urls]));
