...
const WEAPON_MODELS = [
  { id: "FIREARM", models: ["https://static.poly.pizza/3b53f0fe-f86e-451c-816d-6ab9bd265cdc.glb", "https://cdn.jsdelivr.net/gh/SAAAM-LLC/3D_model_bundle@main/SAM_ASSET-PISTOL-IN-HOLSTER.glb"] },
  { id: "RIFLE", models: ["https://static.poly.pizza/b3e6be61-0299-4866-a227-58f5f3fe610b.glb", "https://cdn.jsdelivr.net/gh/microsoft/MixedRealityToolkit@main/SpatialInput/Samples/DemoRoom/Media/Models/Gun.glb"] },
...
const WEAPON_PICKUP_SCALE = { FIREARM: 0.9, RIFLE: 1.1, MISSILE: 1.45, DRONE: 1.2, HELICOPTER: 1.25, JET: 1.35 };
    ...
    async function start() {
      ...
      const makeWeaponPickupMesh = (weapon) => {
        ...
        if (model) {
          ...
          fitVehicleModel(pickup, { targetLength: WEAPON_PICKUP_SCALE[weapon] ?? 1.08, lift: 0.03, yaw: 0 });
          return pickup;
        }
