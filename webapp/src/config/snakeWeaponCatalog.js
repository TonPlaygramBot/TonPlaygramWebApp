...
export const SNAKE_CAPTURE_WEAPON_OPTIONS = Object.freeze([
  ...
  { id: 'slot-10-ak47-gltf', label: 'AK47 GLTF', thumbnail: weaponSilhouetteThumbnail(['#7f1d1d','#111827','#f59e0b']), urls: ['https://cdn.jsdelivr.net/gh/KrishBharadwaj5678/Gunify@main/models/AK47/scene.gltf', 'https://raw.githubusercontent.com/KrishBharadwaj5678/Gunify/main/models/AK47/scene.gltf'] },
