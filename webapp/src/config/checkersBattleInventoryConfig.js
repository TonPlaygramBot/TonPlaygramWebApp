...
// Backward-compatible aliases for reused Chess Battle Royal rendering pipeline.
export const CHESS_CHAIR_OPTIONS = CHECKERS_CHAIR_OPTIONS;
export const CHESS_TABLE_OPTIONS = CHECKERS_TABLE_OPTIONS;
