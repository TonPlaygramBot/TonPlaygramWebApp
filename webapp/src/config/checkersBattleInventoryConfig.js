...
export const CHECKERS_BATTLE_OPTION_THUMBNAILS = Object.freeze({
  sideColor: Object.freeze({
    marble: '/assets/game-art/checkers-battle-royal/pieces/marble.svg',
    darkForest: '/assets/game-art/checkers-battle-royal/pieces/darkForest.svg',
    amberGlow: '/assets/game-art/checkers-battle-royal/pieces/amberGlow.svg',
    mintVale: '/assets/game-art/checkers-battle-royal/pieces/mintVale.svg',
    royalWave: '/assets/game-art/checkers-battle-royal/pieces/royalWave.svg',
    roseMist: '/assets/game-art/checkers-battle-royal/pieces/roseMist.svg',
    amethyst: '/assets/game-art/checkers-battle-royal/pieces/amethyst.svg',
    cinderBlaze: '/assets/game-art/checkers-battle-royal/pieces/cinderBlaze.svg',
    arcticDrift: '/assets/game-art/checkers-battle-royal/pieces/arcticDrift.svg'
  }),
  boardTheme: Object.freeze({
...
export const CHECKERS_BATTLE_STORE_ITEMS = [
  ...
  ...POOL_ROYALE_HDRI_VARIANTS.map((variant, idx) => ({
    ...
    description: 'Pool Royale HDRI environment, tuned for checkers table promos.',
