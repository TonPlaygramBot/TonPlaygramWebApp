...
export const MURLAN_CHARACTER_THEMES = Object.freeze([
  ...
  },
  {
    ...
    price: 760,
    description: 'Sketchfab rigged Mixamo-style character prepared for Murlan Royale seating. Binary GLB is installed locally outside git with npm run fetch:murlan-characters.',
    url: '/models/murlan/agent-47-rigged-face-morphs.glb',
    modelUrls: ['/models/murlan/agent-47-rigged-face-morphs.glb'],
  ...
  },
  {
    ...
    price: 780,
    description: 'Sketchfab human character prepared for Murlan Royale seating. Binary GLB is installed locally outside git with npm run fetch:murlan-characters.',
    url: '/models/murlan/leather-jacket-portrait.glb',
    modelUrls: ['/models/murlan/leather-jacket-portrait.glb'],
  ...
  {
    id: 'sketchfab-seated-gentleman-suede',
    label: 'Seated Gentleman',
    source: 'Sketchfab: Seated Gentleman in Suede Jacket by restore50',
    license: 'CC BY 4.0; attribution required',
    price: 800,
    description: 'Sketchfab seated gentleman character prepared as a premium Murlan Royale table opponent. Binary GLB is installed locally outside git with npm run fetch:murlan-characters.',
    url: '/models/murlan/seated-gentleman-suede-jacket.glb',
    modelUrls: ['/models/murlan/seated-gentleman-suede-jacket.glb'],
  ...
  },
  {
    ...
    license: 'CC BY 4.0; attribution required',
    price: 820,
    description: 'Sketchfab red-hibiscus human character prepared for the Murlan Royale seated character roster. Binary GLB is installed locally outside git with npm run fetch:murlan-characters.',
    url: '/models/murlan/red-hibiscus-in-the-hair.glb',
    modelUrls: ['/models/murlan/red-hibiscus-in-the-hair.glb'],
  ...
  },
  {
    ...
    license: 'CC BY 4.0; attribution required',
    price: 840,
    description: 'Sketchfab casual human character prepared as a randomizable Murlan Royale AI/human character. Binary GLB is installed locally outside git with npm run fetch:murlan-characters.',
    url: '/models/murlan/casual-confidence.glb',
    modelUrls: ['/models/murlan/casual-confidence.glb'],
