...
const CABAN_GREEN_HEXES = ['#33b46a', '#2ca85f', '#42c47a', '#4fd184', '#238f4a'];
const CABAN_OCEAN_BLUE_HEXES = ['#1f9fe3', '#1a90d4', '#33b4f4', '#3fc0ff', '#0f7bbf'];
...
const MATERIAL_SERIES = [
  {
    ...
    greens: CABAN_GREEN_HEXES,
    blues: CABAN_OCEAN_BLUE_HEXES
  },
  {
    prefix: 'polarFleece',
    label: 'Polar Fleece',
