...
export const CAPTURE_ANIMATION_OPTIONS = Object.freeze([
  ...
  {
    id: 'polyRpgLauncher01Attack',
    label: 'Poly Pizza RPG Launcher',
    description: 'Poly Pizza RPG launcher GLB for heavy explosive capture attacks.',
    thumbnail: captureWeaponGlyphThumb('▱', '#4d7c0f')
  },
  {
    id: 'polyBazooka01Attack',
    label: 'Poly Pizza Bazooka',
    description: 'Poly Pizza bazooka GLB tuned as a large shoulder-fired explosive weapon.',
    thumbnail: captureWeaponGlyphThumb('▰', '#854d0e')
  },
  {
    id: 'polyRocketLauncher01Attack',
    label: 'Quaternius Rocket Launcher',
    description: 'Poly Pizza Quaternius rocket launcher model for RPG-style captures.',
    thumbnail: captureWeaponGlyphThumb('▰', '#991b1b')
  },
  {
    id: 'polyGrenadeLauncher01Attack',
    label: 'Quaternius Grenade Launcher',
    description: 'Poly Pizza Quaternius multi-barrel grenade launcher with preserved GLB materials.',
    thumbnail: captureWeaponGlyphThumb('▦', '#475569')
  },
  {
    id: 'polyScifiGrenadeLauncher01Attack',
    label: 'Quaternius Scifi Grenade Launcher',
    description: 'Poly Pizza sci-fi grenade launcher GLB for premium explosive loadouts.',
    thumbnail: captureWeaponGlyphThumb('▣', '#6d28d9')
  },
  {
    id: 'polyFlareGun01Attack',
    label: 'Quaternius Flare Gun',
    description: 'Poly Pizza Quaternius flare gun GLB with compact one-hand pickup timing.',
    thumbnail: captureWeaponGlyphThumb('◖', '#b91c1c')
  },
  {
    id: 'polyGrenade01Attack',
    label: 'Quaternius Grenade',
    description: 'Poly Pizza Quaternius hand grenade GLB for quick explosive throws.',
    thumbnail: captureWeaponThumb('💣', '#365314')
  },
  {
    id: 'polyScifiGrenade01Attack',
    label: 'Quaternius Scifi Grenade',
    description: 'Poly Pizza sci-fi grenade GLB with high-contrast futuristic shell graphics.',
    thumbnail: captureWeaponThumb('💣', '#6d28d9')
  },
  {
    id: 'polyFireGrenade01Attack',
    label: 'Quaternius Fire Grenade',
    description: 'Poly Pizza fire grenade GLB for incendiary explosive capture styling.',
    thumbnail: captureWeaponThumb('🧨', '#b91c1c')
  },
  {
    id: 'polyLandmine01Attack',
    label: 'Quaternius Landmine',
    description: 'Poly Pizza landmine GLB as a compact heavy explosive store weapon.',
    thumbnail: captureWeaponGlyphThumb('◉', '#334155')
  },
  {
    id: 'polyGasTank01Attack',
    label: 'Quaternius Gas Tank',
    description: 'Poly Pizza gas tank GLB for hazardous explosive prop captures.',
    thumbnail: captureWeaponGlyphThumb('▥', '#ca8a04')
  },
  {
    id: 'polyTurretGun01Attack',
    label: 'Quaternius Turret Gun',
    description: 'Poly Pizza turret gun GLB for a heavy mounted-firearm capture profile.',
    thumbnail: captureWeaponGlyphThumb('▩', '#475569')
  },
  {
    id: 'polyCombatTank01Attack',
    label: 'Quaternius Combat Tank',
    description: 'Poly Pizza combat tank GLB scaled as a premium heavy weapon model.',
    thumbnail: captureWeaponThumb('🛡️', '#4d7c0f')
  },
