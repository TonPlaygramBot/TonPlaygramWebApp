...
const EASTERN_CARBINE_GLTF_MODEL_URL =
  '/assets/models/chess-battle-royal/eastern-carbine-rifle/eastern_carbine_rifle.gltf';
...
export const CHESS_EASTERN_CARBINE_CAPTURE_OPTION = Object.freeze({
  ...
  modelUrls: [EASTERN_CARBINE_GLTF_MODEL_URL],
  modelPageUrl:
