...
export const CHESS_EASTERN_CARBINE_CAPTURE_OPTION = Object.freeze({
  ...
  description:
    'Dezryelle Sketchfab eastern_carbine_rifle adapted as a Chess Battle Royal capture weapon with the installed original glTF materials preserved.',
    ...
    description:
      option.id === 'ukrainianDroneAttack'
        ...
        : option.id === CHESS_EASTERN_CARBINE_CAPTURE_OPTION.id
          ? 'Sketchfab eastern_carbine_rifle by Dezryelle (CC BY 4.0), loaded from the installed original glTF so its authored materials stay visible in Chess Battle Royal.'
