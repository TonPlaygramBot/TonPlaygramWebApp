...
export const POOL_ROYALE_TABLE_MODEL_OPTIONS = Object.freeze([
  {
    ...
    description:
      'Royal Original now uses the exact Showood 7 ft GLB upper-table silhouette, pocket layout, rounded rail proportions, and playfield footprint while applying the current Pool Royale procedural cloth, wood, chrome, pocket-jaw, and base materials.',
    tableSizeId: '9ft',
    ...
    keepGeneratedPocketsAndJaws: false,
    preserveSourceTextureRoles: [],
    preserveOriginalSurfaceRoles: [],
    hideSurfaceRoles: [],
    keepGeneratedShell: false,
