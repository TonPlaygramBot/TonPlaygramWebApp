...
export const POOL_ROYALE_TABLE_MODEL_OPTIONS = Object.freeze([
  {
    ...
    description:
      'Royal procedural materials wrapped onto the exact Showood GLB rail, cushion, pocket, and playfield geometry so the Original table now shares the Showood physical layout.',
    tableSizeId: '9ft',
