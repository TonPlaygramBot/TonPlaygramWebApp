...
export const POOL_ROYALE_TABLE_MODEL_OPTIONS = Object.freeze([
  {
    ...
    cornerRimLift: 0.018,
    originalBaseRemovalCutoffRatio: 0.74,
    accentBottomTrimOffset: 0,
    markingVisualLift: 0.024,
    shortRailMarkerOutwardOffset: 0.035,
    brandPlateOutwardOffset: 0.04,
    ...
    footWidthScale: 1.08,
    footHeightScale: 1,
    railSightApronVisualScale: 1.072,
    railSightOutwardOffset: 0.036,
    railSightVisualHeightScale: 1.085,
    sideApronVisualHeightScale: 1.112,
    sideApronOutwardOffset: 0.058,
