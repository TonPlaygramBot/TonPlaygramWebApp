...
export const POOL_ROYALE_TABLE_MODEL_OPTIONS = Object.freeze([
  {
    ...
    description:
      'Open-source Pooltool Showood 7 ft table mounted with its source layout, proportions, and GLB materials preserved; Pool Royale only scales it uniformly for the mobile arena.',
    tableSizeId: '7ft',
    ...
    originalBaseRemovalCutoffRatio: 0,
    markingVisualLift: 0.028,
    clothRepeatScale: 1,
    fitStrategy: 'contain',
    ...
    preserveSourceTextureRoles: ['cloth', 'cushion', 'wood', 'sideWoodApron', 'baseFoot', 'trim', 'pocket'],
    preserveOriginalSurfaceRoles: ['cloth', 'cushion', 'wood', 'trim', 'pocket'],
    forceHideExternalReferenceParts: [],
    keepGeneratedBrandPlates: false,
    keepGeneratedRailMarkersOnExternal: false,
