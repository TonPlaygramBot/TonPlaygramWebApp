...
export const POOL_ROYALE_TABLE_MODEL_OPTIONS = Object.freeze([
  {
    ...
    description:
      "Traditional billiard table option inspired by fizyman's Sketchfab Pool Table Traditional model, installed from Sketchfab as a local GLB so Pool Royale loads the authentic original shape, UV mapping, and baked texture set without committing binary assets.",
    tableSizeId: '8ft',
    baseId: 'mahogany',
    ...
    sourceFormat: 'sketchfab-original-glb',
    sourceUrl:
