...
export const POOL_ROYALE_TABLE_MODEL_OPTIONS = Object.freeze([
  {
    ...
    lowerLegFootReachScale: 1,
    lowerLegReachTarget: 'footBottom',
    lowerLegMaxHeightScale: 1,
    footWidthScale: 1,
    footHeightScale: 1,
    railSightApronVisualScale: 1,
    railSightOutwardOffset: 0,
    railSightVisualHeightScale: 1,
    sideApronVisualHeightScale: 1,
    sideApronOutwardOffset: 0,
    clothRepeatScale: 5.25,
    fitStrategy: 'exact',
    fitReference: 'playfield',
