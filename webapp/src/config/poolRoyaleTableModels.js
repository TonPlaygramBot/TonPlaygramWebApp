...
export const POOL_ROYALE_TABLE_MODEL_OPTIONS = Object.freeze([
  ...
  },
  {
    ...
    description:
      'Open-source Pooltool Showood showroom table matched to Pool Royale footprint while using the Royal procedural base choices plus procedural pocket nets, chrome holders, and leather straps.',
    tableSizeId: '9ft',
    assetUrl: `${POOLTOOL_RAW_BASE}/seven_foot_showood/seven_foot_showood.glb`,
    fallbackAssetUrl: `${POOLTOOL_RAW_BASE}/seven_foot_showood/seven_foot_showood_pbr.glb`,
    icon: '🟫',
    ...
    keepGeneratedPocketHardware: true,
    keepGeneratedPocketsAndJaws: true,
    usePoolRoyaleFinish: true,
