...
export const POOL_ROYALE_TABLE_MODEL_OPTIONS = Object.freeze([
  {
    ...
    description:
      'Fixed Pooltool Showood 7 ft GLB table mapped with the table-top footprint and collision field aligned to the visible Showood rails, cushions, pockets, and jaws. Install the GLB at the local URL outside git; CDN/raw URLs remain runtime fallbacks only.',
    tableSizeId: '7ft',
    ...
    fitStrategy: 'exact',
    fitReference: 'showoodGameplaySurfaces',
