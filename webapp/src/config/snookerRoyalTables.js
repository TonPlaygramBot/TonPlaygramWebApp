const BASE_TABLE_SCALE = 1.56;
const BASE_TABLE_MOBILE_SCALE = 1.68;
const BASE_TABLE_COMPACT_SCALE = 1.48;
const BASE_PLAYFIELD_WIDTH_MM = 3556; // Snooker 12 ft playing surface width (140")

const TABLE_PHYSICAL_SPECS = Object.freeze({
  '12ft': {
    id: '12ft',
    label: '12 ft (Championship)',
    playfield: Object.freeze({ widthMm: 3556, heightMm: 1778 }), // 12' × 6'
    ballDiameterMm: 52.5,
    ...
    sideCushionCutAngleDeg: 35,
    cushionPocketAnglesDeg: Object.freeze({ corner: 142, side: 105 })
  },
  '10ft': {
    id: '10ft',
    label: '10 ft (Club)',
    playfield: Object.freeze({ widthMm: 3048, heightMm: 1524 }), // 10' × 5'
    ballDiameterMm: 52.5,
    pocketMouthMm: Object.freeze({
      corner: 86,
      side: 92
