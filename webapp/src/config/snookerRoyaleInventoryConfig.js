import { SNOOKER_ROYALE_CLOTH_VARIANTS } from './snookerRoyaleClothPresets.js';
...
export const SNOOKER_ROYALE_BASE_VARIANTS = Object.freeze([
  ...
  },
  {
    ...
    description: 'Rounded Poly Haven coffee table legs tucked beneath the snooker table.',
  ...
  },
  {
    ...
    description: 'Alternate Wooden Table 02 variant resized to cradle the snooker playfield.',
