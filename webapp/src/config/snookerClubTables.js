const BASE_TABLE_SCALE = 1.9;
const BASE_TABLE_MOBILE_SCALE = 1.9;
const BASE_TABLE_COMPACT_SCALE = 1.82;
const BASE_PLAYFIELD_WIDTH_MM = 3569; // Standard full-size snooker cloth width
...
function deriveCompactScale(baseScale, compactScale = BASE_TABLE_COMPACT_SCALE) {
  ...
  return Math.max(1.2, Math.min(compactScale, scaled));
}
