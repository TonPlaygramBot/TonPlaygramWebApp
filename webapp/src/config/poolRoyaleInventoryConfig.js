...
const RAW_POOL_ROYALE_HDRI_VARIANTS = [
  ...
  },
  {
    ...
    environmentIntensity: 1.03,
    backgroundIntensity: 0.98,
    swatches: ['#65a30d', '#16a34a'],
    description: 'Sunny suburban garden lighting with lush green bounce.'
  },
  {
    ...
    swatches: ['#60a5fa', '#facc15'],
    description: 'Midday rural track sky for bright realistic outdoor contrast.'
  },
  {
    id: 'autumnPark',
    name: 'Autumn Park',
    ...
    environmentIntensity: 1.03,
    backgroundIntensity: 0.99,
    swatches: ['#f97316', '#b45309'],
    description: 'Warm fall foliage ambience and realistic sunset-adjacent fill.'
  },
  {
    id: 'rooitouPark',
    name: 'Rooitou Park',
    ...
    description: 'Natural park canopy with broad soft light and shadow detail.'
  },
  {
    id: 'rotesRathaus',
    name: 'Rotes Rathaus',
    ...
    description: 'Historic city square reflections with crisp daylight definition.'
  },
  {
    id: 'veniceDawn2',
    name: 'Venice Dawn 2',
    ...
    swatches: ['#a78bfa', '#fb7185'],
    description: 'Early dawn venice tones with balanced cool-warm transitions.'
  },
  {
    id: 'piazzaSanMarco',
    ...
    environmentIntensity: 1.03,
    backgroundIntensity: 0.99,
    swatches: ['#38bdf8', '#f8fafc'],
    description: 'Open piazza environment with natural sky fill and street-level bounce.'
  },
  {
...
export const POOL_ROYALE_OPTION_LABELS = Object.freeze({
  ...
  chromePlateStyle: Object.freeze({
    royalClassic: 'Royal Classic Chrome Plates',
    showoodRounded: 'Showood Rounded Chrome Plates'
  }),
...
export const POOL_ROYALE_STORE_ITEMS = [
  ...
  {
    id: 'chrome-style-showoodRounded',
    type: 'chromePlateStyle',
    optionId: 'showoodRounded',
    name: 'Showood Rounded Chrome Plates',
    price: 420,
    description: 'Rounded showroom-style chrome plate shape that can be applied to either Pool Royale table model.',
    thumbnail: swatchThumbnail(['#f8fafc', '#d4af37', '#7c2d12'])
  },
  {
...
export const POOL_ROYALE_DEFAULT_LOADOUT = [
  ...
  { type: 'chromePlateStyle', optionId: 'royalClassic', label: 'Royal Classic Chrome Plates' },
