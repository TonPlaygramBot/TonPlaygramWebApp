...
const POOL_ROYALE_HDRI_PLACEMENTS = Object.freeze({
  ...
  arenaCrowdPulse: { cameraHeightM: 1.6, groundRadiusMultiplier: 5.4, groundResolution: 120 },
  arenaSpotlightRush: { cameraHeightM: 1.6, groundRadiusMultiplier: 5.3, groundResolution: 120 },
  arenaNeonWave: { cameraHeightM: 1.6, groundRadiusMultiplier: 5.2, groundResolution: 120 },
  arenaVictoryRoar: { cameraHeightM: 1.58, groundRadiusMultiplier: 5.1, groundResolution: 120 },
  arenaShockwave: { cameraHeightM: 1.58, groundRadiusMultiplier: 5.1, groundResolution: 120 }
});
...
const RAW_POOL_ROYALE_HDRI_VARIANTS = [
  ...
  },
  {
    ...
    environmentIntensity: 1.18,
    backgroundIntensity: 1.08,
    swatches: ['#f97316', '#facc15'],
    motionSpeed: 0.022,
    pulseSpeed: 0.7,
    pulseIntensity: 0.08,
    ambientSound: '/assets/sounds/football-crowd-3-69245.mp3',
    ambientVolume: 0.22,
    description: 'Packed arena glow with rolling crowd energy and sweeping light motion.'
  },
  {
    id: 'arenaSpotlightRush',
    name: 'Arena Spotlight Rush',
    assetId: 'music_hall_01',
    preferredResolutions: ['4k', '2k'],
    fallbackResolution: '4k',
    price: 2290,
    ...
    swatches: ['#38bdf8', '#f472b6'],
    motionSpeed: 0.028,
    pulseSpeed: 0.85,
    pulseIntensity: 0.09,
    ambientSound: '/assets/sounds/football-game-sound-effects-359284.mp3',
    ambientVolume: 0.2,
    description: 'Concert arena rig with fast-moving spotlight sweeps and crowd rumble.'
  },
  {
    id: 'arenaNeonWave',
    name: 'Arena Neon Wave',
    assetId: 'music_hall_02',
    preferredResolutions: ['4k', '2k'],
    fallbackResolution: '4k',
    price: 2330,
    ...
    ambientVolume: 0.2,
    description: 'Neon-lit arena shimmer with rolling chants and color-shifted reflections.'
  },
  {
    id: 'arenaVictoryRoar',
    name: 'Arena Victory Roar',
    assetId: 'ballroom',
    preferredResolutions: ['4k', '2k'],
    fallbackResolution: '4k',
    price: 2370,
    ...
    ambientVolume: 0.18,
    description: 'Grand arena glow with celebratory crowd waves and warm chandelier sweep.'
  },
  {
    id: 'arenaShockwave',
    name: 'Arena Shockwave',
    assetId: 'billiard_hall',
    preferredResolutions: ['4k', '2k'],
    fallbackResolution: '4k',
    price: 2410,
    ...
    ambientVolume: 0.18,
    description: 'High-tension arena scene with deep blue wash and reactive crowd surge.'
  }
];
