...
export const POOL_ROYALE_HDRI_VARIANTS = Object.freeze([
  {
    ...
    preferredResolutions: ['16k', '8k', '4k'],
  ...
  },
  {
    ...
    environmentIntensity: 1.08,
    backgroundIntensity: 1.02,
    swatches: ['#0ea5e9', '#1f2937'],
    description: 'BlenderKit free snooker hall capture with arcade-side accents.'
  },
  {
    id: 'emptyPlayRoom',
    ...
    environmentIntensity: 1.04,
    backgroundIntensity: 0.98,
    swatches: ['#eab308', '#9ca3af'],
    description: 'Soft indoor leisure room lighting with gentle neutral fill.'
  },
  {
    ...
    description: 'Festive studio wrap with warm fairy-light reflections.'
  },
  {
    id: 'billiardHall',
    name: 'Billiard Hall',
    ...
    description: 'Authentic billiard hall ambience with even lamp gradients.'
  },
  {
    id: 'colorfulStudio',
    ...
    description: 'Playful studio gradients with vibrant accent sweeps.'
  },
  {
    id: 'dancingHall',
    name: 'Dancing Hall',
    ...
    description: 'Spacious dance hall lighting with balanced top and side spill.'
  }
]);
