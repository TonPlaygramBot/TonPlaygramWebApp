...
export const POOL_ROYALE_HDRI_VARIANTS = Object.freeze([
  ...
  },
  {
    id: 'snookerRoom',
    name: 'Snooker Room',
    customUrl: 'https://hdrihaven.com/files/hdris/snooker_room_8k.hdr',
    preferredResolutions: ['16k', '8k', '4k', '2k'],
    fallbackResolution: '8k',
    price: 1760,
    exposure: 1.08,
    environmentIntensity: 1.02,
    backgroundIntensity: 0.98,
    swatches: ['#1d4ed8', '#22c55e'],
    description: 'BlenderKit free Snooker Room hall with arcade accents and balanced indoor bounce.'
  },
  {
    id: 'emptyPlayRoom',
    ...
    environmentIntensity: 1.04,
    backgroundIntensity: 1,
    swatches: ['#0ea5e9', '#14b8a6'],
    description: 'Clean neutral play room with soft stage lighting and gentle wall bounce.'
  },
  {
    ...
    description: 'Festive holiday studio with warm string lights and cozy fill.'
  },
  {
    id: 'billiardHall',
    name: 'Billiard Hall',
    ...
    environmentIntensity: 1.08,
    backgroundIntensity: 1.04,
    swatches: ['#065f46', '#0ea5e9'],
    description: 'Poly Haven billiard hall ambience with ceiling spots and table-side bounce.'
  },
  {
    id: 'colorfulStudio',
    ...
    description: 'Vibrant multi-hue studio wraps the table in saturated rim effects.'
  },
  {
    id: 'dancingHall',
    name: 'Dancing Hall',
    ...
    environmentIntensity: 1.08,
    backgroundIntensity: 1.04,
    swatches: ['#f97316', '#22c55e'],
    description: 'Spacious dance hall HDRI with bright overheads and polished floor reflections.'
  }
]);
