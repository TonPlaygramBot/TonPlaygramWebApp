...
const POLY_HAVEN_CLOTHS = [
  ...
  { id: 'polar_fleece', label: 'Polar Fleece Cloth', base: 0x0f78d1 },
  { id: 'polar_fleece_ocean_crest', label: 'Polar Fleece Ocean Crest Cloth', base: 0x1a8fe8 },
  { id: 'polar_fleece_ocean_current', label: 'Polar Fleece Ocean Current Cloth', base: 0x157fda },
  { id: 'polar_fleece_ocean_lagoon', label: 'Polar Fleece Ocean Lagoon Cloth', base: 0x279fec },
  { id: 'polar_fleece_ocean_reef', label: 'Polar Fleece Ocean Reef Cloth', base: 0x2faaf5 },
  { id: 'polar_fleece_ocean_abyss', label: 'Polar Fleece Ocean Abyss Cloth', base: 0x0b5f9f },
  ...
  { id: 'caban', label: 'Caban Wool Cloth', base: 0x0a5fa8 },
