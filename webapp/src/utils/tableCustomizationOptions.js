...
const POLY_HAVEN_CLOTHS = [
  ...
  { id: 'polar_fleece', label: 'Polar Fleece Cloth', base: 0x3b8bd6 },
  { id: 'polar_fleece_ocean_crest', label: 'Polar Fleece Ocean Crest Cloth', base: 0x2a78d8 },
  { id: 'polar_fleece_ocean_current', label: 'Polar Fleece Ocean Current Cloth', base: 0x236ed2 },
  { id: 'polar_fleece_ocean_lagoon', label: 'Polar Fleece Ocean Lagoon Cloth', base: 0x358ae0 },
  { id: 'polar_fleece_ocean_reef', label: 'Polar Fleece Ocean Reef Cloth', base: 0x3f95ee },
  { id: 'polar_fleece_ocean_abyss', label: 'Polar Fleece Ocean Abyss Cloth', base: 0x1c66c4 },
  ...
  { id: 'caban', label: 'Caban Wool Cloth', base: 0x2d63a3 },
