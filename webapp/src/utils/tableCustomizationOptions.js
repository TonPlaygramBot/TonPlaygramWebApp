...
const POLY_HAVEN_CLOTHS = [
  ...
  { id: 'polar_fleece', label: 'Polar Fleece Cloth', base: 0x33b46a },
  { id: 'polar_fleece_ocean_crest', label: 'Polar Fleece Ocean Crest Cloth', base: 0x1d9fe8 },
  { id: 'polar_fleece_ocean_current', label: 'Polar Fleece Ocean Current Cloth', base: 0x168fdd },
  { id: 'polar_fleece_ocean_lagoon', label: 'Polar Fleece Ocean Lagoon Cloth', base: 0x33b5f6 },
  { id: 'polar_fleece_ocean_reef', label: 'Polar Fleece Ocean Reef Cloth', base: 0x42c1ff },
  { id: 'polar_fleece_ocean_abyss', label: 'Polar Fleece Ocean Abyss Cloth', base: 0x125aa7 },
  { id: 'polar_fleece_nature_fern', label: 'Polar Fleece Nature Fern Cloth', base: 0x33b46a },
  { id: 'polar_fleece_nature_grove', label: 'Polar Fleece Nature Grove Cloth', base: 0x2ca85f },
  { id: 'polar_fleece_nature_canopy', label: 'Polar Fleece Nature Canopy Cloth', base: 0x42c47a },
  { id: 'polar_fleece_nature_meadow', label: 'Polar Fleece Nature Meadow Cloth', base: 0x4fd184 },
  { id: 'polar_fleece_nature_wildwood', label: 'Polar Fleece Nature Wildwood Cloth', base: 0x238f4a },
