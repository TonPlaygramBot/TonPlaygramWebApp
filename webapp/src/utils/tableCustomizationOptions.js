...
const POLY_HAVEN_CLOTHS = [
  ...
  { id: 'polar_fleece_ocean_crest', label: 'Polar Fleece Ocean Crest Cloth', base: 0x1f7bdc },
  { id: 'polar_fleece_ocean_current', label: 'Polar Fleece Ocean Current Cloth', base: 0x1f74d0 },
  { id: 'polar_fleece_ocean_lagoon', label: 'Polar Fleece Ocean Lagoon Cloth', base: 0x2f90e4 },
  { id: 'polar_fleece_ocean_reef', label: 'Polar Fleece Ocean Reef Cloth', base: 0x379ef0 },
  { id: 'polar_fleece_ocean_abyss', label: 'Polar Fleece Ocean Abyss Cloth', base: 0x1a6bc7 },
