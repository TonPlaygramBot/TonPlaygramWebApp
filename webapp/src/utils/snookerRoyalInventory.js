...
const readMigrationFlags = () => {
  ...
  try {
    ...
    console.warn('Failed to read Snooker Royale migration flags', err);
    return {};
  }
};
...
const syncWithServer = async (accountId, localInventory) => {
  ...
  const promise = (async () => {
    ...
    try {
      ...
      console.warn('Snooker Royale inventory fetch failed, using cache', err);
    ...
    if (needsPersist) {
      try {
        ...
        console.warn('Snooker Royale inventory save failed, keeping cache', err);
      }
    }
...
export const getSnookerRoyalInventory = async (accountId, options = {}) => {
  ...
  try {
    ...
    console.warn('Snooker Royale inventory sync failed, using cache', err);
    return cached;
  }
};
...
export const addSnookerRoyalUnlock = async (type, optionId, accountId) => {
  ...
  try {
    ...
    console.warn('Snooker Royale unlock sync failed, keeping cache', err);
    return nextInventory;
  }
};
