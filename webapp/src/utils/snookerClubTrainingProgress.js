const TRAINING_PROGRESS_KEY = 'snookerClubTrainingProgress';
...
export function loadTrainingProgress() {
  ...
  try {
    ...
    console.warn('Failed to load Snooker Club training progress', err);
...
export function persistTrainingProgress(progress) {
  ...
  try {
    ...
    console.warn('Failed to persist Snooker Club training progress', err);
  }
}
