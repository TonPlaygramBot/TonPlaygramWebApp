const TRAINING_PROGRESS_KEY = 'snookerRoyalTrainingProgress';

export const TRAINING_LEVELS = [
  {
    level: 1,
    title: 'Opening break-off',
    objective: 'Place the cue ball, hit the pack cleanly, and pocket any object ball.',
  ...
  },
  {
    ...
    reward: 'Cue-ball-in-hand respot practice.'
  },
  {
    level: 3,
    title: 'Build a break',
    objective: 'Pot three balls in one visit without scratching.',
    reward: 'Pro tip overlays for long pots.'
  },
  {
    level: 4,
    title: 'Finishing shot',
    objective: 'Clear the final colour under pressure to close the frame.',
