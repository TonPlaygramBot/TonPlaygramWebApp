...
export const WOOD_GRAIN_OPTIONS = Object.freeze([
  ...
  Object.freeze({
    ...
    rail: {
      repeat: { x: 0.024, y: 1.04 },
      rotation: Math.PI / 48,
      textureSize: 4096
    },
    frame: {
      repeat: { x: 0.24, y: 0.92 },
      rotation: Math.PI / 16,
      textureSize: 4096
    }
  }),
  ...
  Object.freeze({
    ...
    rail: {
      repeat: { x: 0.02, y: 1.12 },
      rotation: Math.PI / 36,
      textureSize: 4096
    },
    frame: {
      repeat: { x: 0.28, y: 0.86 },
      rotation: Math.PI / 10,
      textureSize: 4096
    }
  }),
  Object.freeze({
    ...
    rail: {
      repeat: { x: 0.023, y: 1.06 },
      rotation: Math.PI / 32,
      textureSize: 4096
    },
    frame: {
      repeat: { x: 0.25, y: 0.88 },
      rotation: Math.PI / 14,
      textureSize: 4096
    }
  })
