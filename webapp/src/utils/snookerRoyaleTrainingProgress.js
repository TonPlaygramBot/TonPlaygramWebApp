const TRAINING_PROGRESS_KEY = 'snookerRoyaleTrainingProgress';
...
export function loadTrainingProgress() {
  ...
  try {
    ...
    console.warn('Failed to load Snooker Royal training progress', err);
...
export function persistTrainingProgress(progress) {
  ...
  try {
    ...
    console.warn('Failed to persist Snooker Royal training progress', err);
  }
}
