...
const TableTennisRoyal = React.lazy(() => import('./pages/Games/TableTennisRoyal.jsx'));
const TableTennisRoyalLobby = React.lazy(() => import('./pages/Games/TableTennisRoyalLobby.jsx'));
...
const SnookerTournament = React.lazy(() => import('./games/snooker/SnookerCareer').then((module) => ({ default: module.SnookerTournament })));
        ...
        <Layout>
          ...
          >
            <Routes>
              ...
              <Route path="/creator-studio" element={<Navigate to="/wall" replace />} />
              ...
              <Route
                ...
                element={
                  ...
                  >
                    <GameLiveAvatarOverlay gameSlug="checkersbattleroyal" onlineOnly>
                      <CheckersBattleRoyal />
                    </GameLiveAvatarOverlay>
                  </Suspense>
                }
              ...
              />
              <Route
                path="/games/snookerroyale/tournament"
                element={<SnookerTournament />}
              />
              <Route
