import { MatchStatus, ParticipantResult, type Prisma } from '@prisma/client';
...
export async function createMatch(params: {
  ...
  players: Array<{ userId: string; role: string }>;
}) {
...
export async function startMatch(matchId: string, stateSnapshot: Prisma.JsonObject) {
...
export async function finishMatch(payload: {
  ...
  resultSummary: Prisma.JsonObject;
}) {
...
export async function listMatchHistory(userId: string, limit = 20) {
