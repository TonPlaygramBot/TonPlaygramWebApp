...
export class NineBall {
  ...
  shotTaken (shot = {}) {
    ...
    const isBreakShot = Boolean(shot.isBreak);
    ...
    if (shot.breakNoFoulGrace && isBreakShot && foul && !pottedList.includes(0) && !shot.cueOffTable && (reason === 'no contact' || reason === 'no cushion')) {
      foul = false;
      reason = '';
    }
