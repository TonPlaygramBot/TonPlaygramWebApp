...
- [Snakes & Ladders / Chutes & Ladders](https://github.com/yashksaini/snakes-and-ladders-game) – Custom avatars, virtual board, and climb/slide animations. This repo includes an online version supporting up to four players at `/games/snake`.
