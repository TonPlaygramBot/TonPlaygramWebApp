...
export function createRacingPreviewWorld(data:any,freeRoam=false){
  const {track,buildings,trees,roads,waterAreas,bounds,tyres}=data;
  ...
  for(const water of waterAreas)for(const polygon of water.polygons){
