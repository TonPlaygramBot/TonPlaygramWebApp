...
return {track,buildings,trees,tyres:tyreBarrierLayout(track,buildingClearance).positions.map(p=>({...p,x:+p.x.toFixed(3),z:+p.z.toFixed(3)}))};
});
const packed=gzipSync(JSON.stringify({courses,models}),{level:9}).toString('base64');
