...
public class CameraController : MonoBehaviour
{
    ...
    // the cue stick.
    public float minimumCueViewDistance = 1.12f;
    // How far above the rails the camera is allowed to travel.
    public float maxHeightAboveTable = 1.92f;
    ...
    public float minDistanceFromCenter = 1.4f;
    ...
    public float lowHeightDistanceReduction = 1.1f;
    ...
    public float lookAtHeightOffset = 0.09f;
