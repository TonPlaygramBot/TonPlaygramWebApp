...
public class CueCamera : MonoBehaviour
{
    ...
    public float cueRaisedDistanceFromBall = 0.56f;
    ...
    public float cueDistancePullIn = 0.62f;
    ...
    public float cueRaisedHeight = 0.78f;
    ...
    public float cueLoweredHeight = 0.22f;
    ...
    public float cueLoweredForwardPush = 0.12f;
    ...
    [Range(0.1f, 1f)]
    public float cueRaisedDistanceScale = 0.72f;
    ...
    public float broadcastHeight = 0.46f;
    ...
    [Range(0f, 0.25f)]
    public float broadcastSafeMargin = 0.035f;
    ...
    // visible.
    public float broadcastMinDistance = 1.02f;
