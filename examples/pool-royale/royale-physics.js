...
// pocket centers
const CORNER_INSET = 0.06; // move corner pockets slightly toward table center
const POCKETS = [
  [CORNER_INSET, CORNER_INSET],
  [TABLE_WIDTH / 2, 0],
  [TABLE_WIDTH - CORNER_INSET, CORNER_INSET],
  [CORNER_INSET, TABLE_HEIGHT - CORNER_INSET],
  [TABLE_WIDTH / 2, TABLE_HEIGHT],
  [TABLE_WIDTH - CORNER_INSET, TABLE_HEIGHT - CORNER_INSET]
];
