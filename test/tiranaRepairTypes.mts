...
import { makeTrack, createRacer, stepRace, aiInput, TRACKS, CUPS, type Input, type Racer, type Track } from '../webapp/src/games/kartroyale/simulation.mjs';
import { createHeldRaceInput } from '../webapp/src/games/kartroyale/heldRaceInput.mjs';
import { finishKartTask, freshKartTasks, type KartTasks } from '../webapp/src/games/kartroyale/kartTaskCore.mjs';
...
export type TrackFactoryIsTyped = AssertFalse<IsAny<ReturnType<typeof makeTrack>>>;
