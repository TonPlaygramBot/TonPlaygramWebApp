...
export default function WeaponKartGameMobileAssets() {
  ...
  useEffect(() => {
    ...
    const pointerUp = (e) => {
      ...
      const quickTap = moved < 12 && performance.now() - input.tapTime < 260;
  ...
  return (
    <div style={{ position: "fixed", inset: 0, overflow: "hidden", background: "#85c7f2", touchAction: "none", userSelect: "none" }}>
      ...
      <div style={{ position: "fixed", inset: 0, pointerEvents: "none", color: "white", fontFamily: "system-ui, -apple-system, Segoe UI, sans-serif" }}>
        <div style={{ position: "absolute", top: 10, left: 10, right: 10, display: "grid", gap: 8 }}>
        ...
        <div style={{ position: "absolute", right: 12, top: 112, width: 86, height: 86, borderRadius: 16, background: "rgba(0,0,0,.45)", border: "1px solid rgba(255,255,255,.14)", overflow: "hidden" }}>
