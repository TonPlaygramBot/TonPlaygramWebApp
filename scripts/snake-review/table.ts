...
const table = createMurlanStyleTable({ arena: new THREE.Group(), tableRadius: D.tableRadius,
  tableHeight: D.tableHeight, includeBase: false, flushPlayingSurface: true, textures: false });
...
export const tableAssets = { table: table.group.toJSON(), tableOutline: Array.from({ length: 128 }, (_, i) => {
